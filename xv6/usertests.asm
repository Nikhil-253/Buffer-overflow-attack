...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       e:	68 72 45 00 00       	push   $0x4572
      13:	50                   	push   %eax
      14:	e8 8b 41 00 00       	call   41a4 <printf>
      19:	83 c4 10             	add    $0x10,%esp

  if(mkdir("iputdir") < 0){
      1c:	83 ec 0c             	sub    $0xc,%esp
      1f:	68 7d 45 00 00       	push   $0x457d
    ...
    printf(stdout, "mkdir failed\n");
      ...
      38:	68 85 45 00 00       	push   $0x4585
      3d:	50                   	push   %eax
      3e:	e8 61 41 00 00       	call   41a4 <printf>
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      67:	68 93 45 00 00       	push   $0x4593
      6c:	50                   	push   %eax
      6d:	e8 32 41 00 00       	call   41a4 <printf>
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      96:	68 b4 45 00 00       	push   $0x45b4
      9b:	50                   	push   %eax
      9c:	e8 03 41 00 00       	call   41a4 <printf>
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      ...
      c5:	68 d0 45 00 00       	push   $0x45d0
      ca:	50                   	push   %eax
      cb:	e8 d4 40 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      e0:	68 e0 45 00 00       	push   $0x45e0
      e5:	50                   	push   %eax
      e6:	e8 b9 40 00 00       	call   41a4 <printf>
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      ff:	68 ee 45 00 00       	push   $0x45ee
     104:	50                   	push   %eax
     105:	e8 9a 40 00 00       	call   41a4 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     123:	68 fd 45 00 00       	push   $0x45fd
     128:	50                   	push   %eax
     129:	e8 76 40 00 00       	call   41a4 <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     143:	68 7d 45 00 00       	push   $0x457d
     ...
     15c:	68 85 45 00 00       	push   $0x4585
     161:	50                   	push   %eax
     162:	e8 3d 40 00 00       	call   41a4 <printf>
    ...
    if(chdir("iputdir") < 0){
     ...
     172:	68 7d 45 00 00       	push   $0x457d
     ...
     18b:	68 0a 46 00 00       	push   $0x460a
     190:	50                   	push   %eax
     191:	e8 0e 40 00 00       	call   41a4 <printf>
    ...
    if(unlink("../iputdir") < 0){
     ...
     1a1:	68 a9 45 00 00       	push   $0x45a9
     ...
     1ba:	68 b4 45 00 00       	push   $0x45b4
     1bf:	50                   	push   %eax
     1c0:	e8 df 3f 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1df:	68 1e 46 00 00       	push   $0x461e
     1e4:	50                   	push   %eax
     1e5:	e8 ba 3f 00 00       	call   41a4 <printf>
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1fe:	68 30 46 00 00       	push   $0x4630
     203:	50                   	push   %eax
     204:	e8 9b 3f 00 00       	call   41a4 <printf>
     209:	83 c4 10             	add    $0x10,%esp
  if(mkdir("oidir") < 0){
     20c:	83 ec 0c             	sub    $0xc,%esp
     20f:	68 3f 46 00 00       	push   $0x463f
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     228:	68 45 46 00 00       	push   $0x4645
     22d:	50                   	push   %eax
     22e:	e8 71 3f 00 00       	call   41a4 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     251:	68 fd 45 00 00       	push   $0x45fd
     256:	50                   	push   %eax
     257:	e8 48 3f 00 00       	call   41a4 <printf>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     26d:	6a 02                	push   $0x2
     26f:	68 3f 46 00 00       	push   $0x463f
    ...
    if(fd >= 0){
     ...
     28d:	68 5c 46 00 00       	push   $0x465c
     292:	50                   	push   %eax
     293:	e8 0c 3f 00 00       	call   41a4 <printf>
  ...
  if(unlink("oidir") != 0){
     ...
     2b5:	68 3f 46 00 00       	push   $0x463f
    ...
    printf(stdout, "unlink failed\n");
     ...
     2ce:	68 80 46 00 00       	push   $0x4680
     2d3:	50                   	push   %eax
     2d4:	e8 cb 3e 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2ee:	68 8f 46 00 00       	push   $0x468f
     2f3:	50                   	push   %eax
     2f4:	e8 ab 3e 00 00       	call   41a4 <printf>
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     30d:	68 a1 46 00 00       	push   $0x46a1
     312:	50                   	push   %eax
     313:	e8 8c 3e 00 00       	call   41a4 <printf>
     318:	83 c4 10             	add    $0x10,%esp
  fd = open("echo", 0);
     31b:	83 ec 08             	sub    $0x8,%esp
     31e:	6a 00                	push   $0x0
     320:	68 5c 45 00 00       	push   $0x455c
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     33e:	68 ac 46 00 00       	push   $0x46ac
     343:	50                   	push   %eax
     344:	e8 5b 3e 00 00       	call   41a4 <printf>
  ...
  fd = open("doesnotexist", 0);
     ...
     362:	6a 00                	push   $0x0
     364:	68 bf 46 00 00       	push   $0x46bf
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     382:	68 cc 46 00 00       	push   $0x46cc
     387:	50                   	push   %eax
     388:	e8 17 3e 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "open test ok\n");
     ...
     39d:	68 ea 46 00 00       	push   $0x46ea
     3a2:	50                   	push   %eax
     3a3:	e8 fc 3d 00 00       	call   41a4 <printf>
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     3bc:	68 f8 46 00 00       	push   $0x46f8
     3c1:	50                   	push   %eax
     3c2:	e8 dd 3d 00 00       	call   41a4 <printf>
     3c7:	83 c4 10             	add    $0x10,%esp
  fd = open("small", O_CREATE|O_RDWR);
     3ca:	83 ec 08             	sub    $0x8,%esp
     3cd:	68 02 02 00 00       	push   $0x202
     3d2:	68 09 47 00 00       	push   $0x4709
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3f0:	68 0f 47 00 00       	push   $0x470f
     3f5:	50                   	push   %eax
     3f6:	e8 a9 3d 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     412:	68 2a 47 00 00       	push   $0x472a
     417:	50                   	push   %eax
     418:	e8 87 3d 00 00       	call   41a4 <printf>
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     428:	6a 0a                	push   $0xa
     42a:	68 46 47 00 00       	push   $0x4746
     ...
     44a:	68 54 47 00 00       	push   $0x4754
     44f:	50                   	push   %eax
     450:	e8 4f 3d 00 00       	call   41a4 <printf>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     460:	6a 0a                	push   $0xa
     462:	68 78 47 00 00       	push   $0x4778
     ...
     482:	68 84 47 00 00       	push   $0x4784
     487:	50                   	push   %eax
     488:	e8 17 3d 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "writes ok\n");
     ...
     4a7:	68 a8 47 00 00       	push   $0x47a8
     4ac:	50                   	push   %eax
     4ad:	e8 f2 3c 00 00       	call   41a4 <printf>
  ...
  fd = open("small", O_RDONLY);
     ...
     4c6:	6a 00                	push   $0x0
     4c8:	68 09 47 00 00       	push   $0x4709
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4e6:	68 b3 47 00 00       	push   $0x47b3
     4eb:	50                   	push   %eax
     4ec:	e8 b3 3c 00 00       	call   41a4 <printf>
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     522:	68 cc 47 00 00       	push   $0x47cc
     527:	50                   	push   %eax
     528:	e8 77 3c 00 00       	call   41a4 <printf>
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     53d:	68 e7 47 00 00       	push   $0x47e7
     542:	50                   	push   %eax
     543:	e8 5c 3c 00 00       	call   41a4 <printf>
  ...
  if(unlink("small") < 0){
     ...
     55c:	68 09 47 00 00       	push   $0x4709
    ...
    printf(stdout, "read failed\n");
     ...
     577:	68 fa 47 00 00       	push   $0x47fa
     57c:	50                   	push   %eax
     57d:	e8 22 3c 00 00       	call   41a4 <printf>
    ...
    printf(stdout, "unlink small failed\n");
     ...
     592:	68 07 48 00 00       	push   $0x4807
     597:	50                   	push   %eax
     598:	e8 07 3c 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5ad:	68 1c 48 00 00       	push   $0x481c
     5b2:	50                   	push   %eax
     5b3:	e8 ec 3b 00 00       	call   41a4 <printf>
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     5cc:	68 30 48 00 00       	push   $0x4830
     5d1:	50                   	push   %eax
     5d2:	e8 cd 3b 00 00       	call   41a4 <printf>
     5d7:	83 c4 10             	add    $0x10,%esp

  fd = open("big", O_CREATE|O_RDWR);
     5da:	83 ec 08             	sub    $0x8,%esp
     5dd:	68 02 02 00 00       	push   $0x202
     5e2:	68 40 48 00 00       	push   $0x4840
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     600:	68 44 48 00 00       	push   $0x4844
     605:	50                   	push   %eax
     606:	e8 99 3b 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     650:	68 5e 48 00 00       	push   $0x485e
     655:	50                   	push   %eax
     656:	e8 49 3b 00 00       	call   41a4 <printf>
  ...
  fd = open("big", O_RDONLY);
     ...
     682:	6a 00                	push   $0x0
     684:	68 40 48 00 00       	push   $0x4840
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     6a2:	68 7c 48 00 00       	push   $0x487c
     6a7:	50                   	push   %eax
     6a8:	e8 f7 3a 00 00       	call   41a4 <printf>
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6f1:	68 95 48 00 00       	push   $0x4895
     6f6:	50                   	push   %eax
     6f7:	e8 a8 3a 00 00       	call   41a4 <printf>
     ...
     718:	68 b2 48 00 00       	push   $0x48b2
     71d:	50                   	push   %eax
     71e:	e8 81 3a 00 00       	call   41a4 <printf>
    ...
    if(((int*)buf)[0] != n){
     ...
     747:	68 c4 48 00 00       	push   $0x48c4
     74c:	50                   	push   %eax
     74d:	e8 52 3a 00 00       	call   41a4 <printf>
  ...
  if(unlink("big") < 0){
     ...
     775:	68 40 48 00 00       	push   $0x4840
    ...
    printf(stdout, "unlink big failed\n");
     ...
     78e:	68 e4 48 00 00       	push   $0x48e4
     793:	50                   	push   %eax
     794:	e8 0b 3a 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "big files ok\n");
     ...
     7a9:	68 f7 48 00 00       	push   $0x48f7
     7ae:	50                   	push   %eax
     7af:	e8 f0 39 00 00       	call   41a4 <printf>
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     7c8:	68 08 49 00 00       	push   $0x4908
     7cd:	50                   	push   %eax
     7ce:	e8 d1 39 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     86c:	68 30 49 00 00       	push   $0x4930
     871:	50                   	push   %eax
     872:	e8 2d 39 00 00       	call   41a4 <printf>
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     88b:	68 56 49 00 00       	push   $0x4956
     890:	50                   	push   %eax
     891:	e8 0e 39 00 00       	call   41a4 <printf>
     896:	83 c4 10             	add    $0x10,%esp

  if(mkdir("dir0") < 0){
     899:	83 ec 0c             	sub    $0xc,%esp
     89c:	68 62 49 00 00       	push   $0x4962
    ...
    printf(stdout, "mkdir failed\n");
     ...
     8b5:	68 85 45 00 00       	push   $0x4585
     8ba:	50                   	push   %eax
     8bb:	e8 e4 38 00 00       	call   41a4 <printf>
  ...
  if(chdir("dir0") < 0){
     ...
     8cb:	68 62 49 00 00       	push   $0x4962
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8e4:	68 67 49 00 00       	push   $0x4967
     8e9:	50                   	push   %eax
     8ea:	e8 b5 38 00 00       	call   41a4 <printf>
  ...
  if(chdir("..") < 0){
     ...
     8fa:	68 7a 49 00 00       	push   $0x497a
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     913:	68 7d 49 00 00       	push   $0x497d
     918:	50                   	push   %eax
     919:	e8 86 38 00 00       	call   41a4 <printf>
  ...
  if(unlink("dir0") < 0){
     ...
     929:	68 62 49 00 00       	push   $0x4962
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     942:	68 8e 49 00 00       	push   $0x498e
     947:	50                   	push   %eax
     948:	e8 57 38 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     95d:	68 a2 49 00 00       	push   $0x49a2
     962:	50                   	push   %eax
     963:	e8 3c 38 00 00       	call   41a4 <printf>
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     97c:	68 b1 49 00 00       	push   $0x49b1
     981:	50                   	push   %eax
     982:	e8 1d 38 00 00       	call   41a4 <printf>
     987:	83 c4 10             	add    $0x10,%esp
  if(exec("echo", echoargv) < 0){
     98a:	83 ec 08             	sub    $0x8,%esp
     98d:	68 a0 64 00 00       	push   $0x64a0
     992:	68 5c 45 00 00       	push   $0x455c
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9ab:	68 bc 49 00 00       	push   $0x49bc
     9b0:	50                   	push   %eax
     9b1:	e8 ee 37 00 00       	call   41a4 <printf>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     9dd:	68 ce 49 00 00       	push   $0x49ce
     9e2:	6a 01                	push   $0x1
     9e4:	e8 bb 37 00 00       	call   41a4 <printf>
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a70:	68 dd 49 00 00       	push   $0x49dd
     a75:	6a 01                	push   $0x1
     a77:	e8 28 37 00 00       	call   41a4 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae8:	68 eb 49 00 00       	push   $0x49eb
     aed:	6a 01                	push   $0x1
     aef:	e8 b0 36 00 00       	call   41a4 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b55:	68 f9 49 00 00       	push   $0x49f9
     b5a:	6a 01                	push   $0x1
     b5c:	e8 43 36 00 00       	call   41a4 <printf>
  ...
  printf(1, "pipe1 ok\n");
     ...
     b80:	68 1f 4a 00 00       	push   $0x4a1f
     b85:	6a 01                	push   $0x1
     b87:	e8 18 36 00 00       	call   41a4 <printf>
     b8c:	83 c4 10             	add    $0x10,%esp
     b8f:	eb 17                	jmp    ba8 <pipe1+0x1e7>
    printf(1, "fork() failed\n");
     b91:	83 ec 08             	sub    $0x8,%esp
     b94:	68 10 4a 00 00       	push   $0x4a10
     b99:	6a 01                	push   $0x1
     b9b:	e8 04 36 00 00       	call   41a4 <printf>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     bb3:	68 29 4a 00 00       	push   $0x4a29
     bb8:	6a 01                	push   $0x1
     bba:	e8 e5 35 00 00       	call   41a4 <printf>
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c14:	6a 01                	push   $0x1
     c16:	68 33 4a 00 00       	push   $0x4a33
     c1b:	50                   	push   %eax
     ...
     c2c:	68 35 4a 00 00       	push   $0x4a35
     c31:	6a 01                	push   $0x1
     c33:	e8 6c 35 00 00       	call   41a4 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c66:	68 e0 64 00 00       	push   $0x64e0
     c6b:	50                   	push   %eax
    ...
    printf(1, "preempt read error");
     ...
     c7c:	68 49 4a 00 00       	push   $0x4a49
     c81:	6a 01                	push   $0x1
     c83:	e8 1c 35 00 00       	call   41a4 <printf>
  ...
  printf(1, "kill... ");
     ...
     c9f:	68 5c 4a 00 00       	push   $0x4a5c
     ca4:	6a 01                	push   $0x1
     ca6:	e8 f9 34 00 00       	call   41a4 <printf>
  ...
  printf(1, "wait... ");
     ...
     cdb:	68 65 4a 00 00       	push   $0x4a65
     ce0:	6a 01                	push   $0x1
     ce2:	e8 bd 34 00 00       	call   41a4 <printf>
  ...
  printf(1, "preempt ok\n");
     ...
     cfc:	68 6e 4a 00 00       	push   $0x4a6e
     d01:	6a 01                	push   $0x1
     d03:	e8 9c 34 00 00       	call   41a4 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d2d:	68 fd 45 00 00       	push   $0x45fd
     d32:	6a 01                	push   $0x1
     d34:	e8 6b 34 00 00       	call   41a4 <printf>
    ...
    if(pid){
     ...
     d51:	68 7a 4a 00 00       	push   $0x4a7a
     d56:	6a 01                	push   $0x1
     d58:	e8 47 34 00 00       	call   41a4 <printf>
  ...
  printf(1, "exitwait ok\n");
     ...
     d74:	68 8a 4a 00 00       	push   $0x4a8a
     d79:	6a 01                	push   $0x1
     d7b:	e8 24 34 00 00       	call   41a4 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     d8e:	68 97 4a 00 00       	push   $0x4a97
     d93:	6a 01                	push   $0x1
     d95:	e8 0a 34 00 00       	call   41a4 <printf>
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dd6:	e8 9d 36 00 00       	call   4478 <malloc>
    ...
    while(m1){
     ...
     df7:	e8 3a 35 00 00       	call   4336 <free>
    ...
    m1 = malloc(1024*20);
     ...
     e13:	e8 60 36 00 00       	call   4478 <malloc>
    ...
    if(m1 == 0){
     ...
     e27:	68 a1 4a 00 00       	push   $0x4aa1
     e2c:	6a 01                	push   $0x1
     e2e:	e8 71 33 00 00       	call   41a4 <printf>
    ...
    free(m1);
     ...
     e4f:	e8 e2 34 00 00       	call   4336 <free>
     e54:	83 c4 10             	add    $0x10,%esp
    printf(1, "mem ok\n");
     e57:	83 ec 08             	sub    $0x8,%esp
     e5a:	68 bb 4a 00 00       	push   $0x4abb
     e5f:	6a 01                	push   $0x1
     e61:	e8 3e 33 00 00       	call   41a4 <printf>
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ebf:	68 dc 4a 00 00       	push   $0x4adc
     ec4:	6a 01                	push   $0x1
     ec6:	e8 d9 32 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f24:	68 08 4b 00 00       	push   $0x4b08
     f29:	6a 01                	push   $0x1
     f2b:	e8 74 32 00 00       	call   41a4 <printf>
  ...
  fd = open("sharedfd", 0);
     ...
     f63:	6a 00                	push   $0x0
     f65:	68 d2 4a 00 00       	push   $0x4ad2
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     f7e:	68 28 4b 00 00       	push   $0x4b28
     f83:	6a 01                	push   $0x1
     f85:	e8 1a 32 00 00       	call   41a4 <printf>
  ...
  unlink("sharedfd");
    ...
    100a:	68 d2 4a 00 00       	push   $0x4ad2
  ...
  if(nc == 10000 && np == 10000){
    ...
    1031:	6a 01                	push   $0x1
    1033:	e8 6c 31 00 00       	call   41a4 <printf>
    ...
    1043:	68 60 4b 00 00       	push   $0x4b60
    1048:	6a 01                	push   $0x1
    104a:	e8 55 31 00 00       	call   41a4 <printf>
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    105f:	c7 45 c8 75 4b 00 00 	movl   $0x4b75,-0x38(%ebp)
    1066:	c7 45 cc 78 4b 00 00 	movl   $0x4b78,-0x34(%ebp)
    106d:	c7 45 d0 7b 4b 00 00 	movl   $0x4b7b,-0x30(%ebp)
    1074:	c7 45 d4 7e 4b 00 00 	movl   $0x4b7e,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    107b:	83 ec 08             	sub    $0x8,%esp
    107e:	68 81 4b 00 00       	push   $0x4b81
    1083:	6a 01                	push   $0x1
    1085:	e8 1a 31 00 00       	call   41a4 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10c2:	68 fd 45 00 00       	push   $0x45fd
    10c7:	6a 01                	push   $0x1
    10c9:	e8 d6 30 00 00       	call   41a4 <printf>
    ...
    10ff:	68 91 4b 00 00       	push   $0x4b91
    1104:	6a 01                	push   $0x1
    1106:	e8 99 30 00 00       	call   41a4 <printf>
    ...
    1121:	50                   	push   %eax
    1122:	68 e0 64 00 00       	push   $0x64e0
    ...
    1140:	68 e0 64 00 00       	push   $0x64e0
    ...
    1162:	68 a0 4b 00 00       	push   $0x4ba0
    1167:	6a 01                	push   $0x1
    1169:	e8 36 30 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    11e9:	05 e0 64 00 00       	add    $0x64e0,%eax
    ...
    1201:	68 b1 4b 00 00       	push   $0x4bb1
    1206:	6a 01                	push   $0x1
    1208:	e8 97 2f 00 00       	call   41a4 <printf>
    ...
    122f:	68 e0 64 00 00       	push   $0x64e0
    ...
    1265:	68 bd 4b 00 00       	push   $0x4bbd
    126a:	6a 01                	push   $0x1
    126c:	e8 33 2f 00 00       	call   41a4 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    1298:	68 ce 4b 00 00       	push   $0x4bce
    129d:	6a 01                	push   $0x1
    129f:	e8 00 2f 00 00       	call   41a4 <printf>
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    12b3:	68 dc 4b 00 00       	push   $0x4bdc
    12b8:	6a 01                	push   $0x1
    12ba:	e8 e5 2e 00 00       	call   41a4 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12df:	68 fd 45 00 00       	push   $0x45fd
    12e4:	6a 01                	push   $0x1
    12e6:	e8 b9 2e 00 00       	call   41a4 <printf>
    ...
    133f:	68 91 4b 00 00       	push   $0x4b91
    1344:	6a 01                	push   $0x1
    1346:	e8 59 2e 00 00       	call   41a4 <printf>
    ...
    1399:	68 80 46 00 00       	push   $0x4680
    139e:	6a 01                	push   $0x1
    13a0:	e8 ff 2d 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < N; i++){
    ...
    144e:	50                   	push   %eax
    144f:	68 f0 4b 00 00       	push   $0x4bf0
    1454:	6a 01                	push   $0x1
    1456:	e8 49 2d 00 00       	call   41a4 <printf>
    ...
    147b:	50                   	push   %eax
    147c:	68 14 4c 00 00       	push   $0x4c14
    1481:	6a 01                	push   $0x1
    1483:	e8 1c 2d 00 00       	call   41a4 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    150a:	68 34 4c 00 00       	push   $0x4c34
    150f:	6a 01                	push   $0x1
    1511:	e8 8e 2c 00 00       	call   41a4 <printf>
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1525:	68 45 4c 00 00       	push   $0x4c45
    152a:	6a 01                	push   $0x1
    152c:	e8 73 2c 00 00       	call   41a4 <printf>
    1531:	83 c4 10             	add    $0x10,%esp
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1534:	83 ec 08             	sub    $0x8,%esp
    1537:	68 02 02 00 00       	push   $0x202
    153c:	68 56 4c 00 00       	push   $0x4c56
  ...
  if(fd < 0){
    ...
    1555:	68 61 4c 00 00       	push   $0x4c61
    155a:	6a 01                	push   $0x1
    155c:	e8 43 2c 00 00       	call   41a4 <printf>
  ...
  write(fd, "hello", 5);
    ...
    156c:	6a 05                	push   $0x5
    156e:	68 7b 4c 00 00       	push   $0x4c7b
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    158f:	6a 02                	push   $0x2
    1591:	68 56 4c 00 00       	push   $0x4c56
  ...
  if(fd < 0){
    ...
    15aa:	68 81 4c 00 00       	push   $0x4c81
    15af:	6a 01                	push   $0x1
    15b1:	e8 ee 2b 00 00       	call   41a4 <printf>
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c1:	68 56 4c 00 00       	push   $0x4c56
    ...
    15d5:	68 99 4c 00 00       	push   $0x4c99
    15da:	6a 01                	push   $0x1
    15dc:	e8 c3 2b 00 00       	call   41a4 <printf>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15f1:	68 56 4c 00 00       	push   $0x4c56
  ...
  write(fd1, "yyy", 3);
    ...
    1604:	6a 03                	push   $0x3
    1606:	68 b3 4c 00 00       	push   $0x4cb3
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	68 e0 64 00 00       	push   $0x64e0
    ...
    1644:	68 b7 4c 00 00       	push   $0x4cb7
    1649:	6a 01                	push   $0x1
    164b:	e8 54 2b 00 00       	call   41a4 <printf>
    1650:	83 c4 10             	add    $0x10,%esp
    exit();
    1653:	e8 b0 29 00 00       	call   4008 <exit>
  }
  if(buf[0] != 'h'){
    1658:	0f b6 05 e0 64 00 00 	movzbl 0x64e0,%eax
    165f:	3c 68                	cmp    $0x68,%al
    1661:	74 17                	je     167a <unlinkread+0x15e>
    printf(1, "unlinkread wrong data\n");
    1663:	83 ec 08             	sub    $0x8,%esp
    1666:	68 ce 4c 00 00       	push   $0x4cce
    166b:	6a 01                	push   $0x1
    166d:	e8 32 2b 00 00       	call   41a4 <printf>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    167d:	6a 0a                	push   $0xa
    167f:	68 e0 64 00 00       	push   $0x64e0
    ...
    1697:	68 e5 4c 00 00       	push   $0x4ce5
    169c:	6a 01                	push   $0x1
    169e:	e8 01 2b 00 00       	call   41a4 <printf>
  ...
  unlink("unlinkread");
    ...
    16bc:	68 56 4c 00 00       	push   $0x4c56
    16c1:	e8 92 29 00 00       	call   4058 <unlink>
    16c6:	83 c4 10             	add    $0x10,%esp
  printf(1, "unlinkread ok\n");
    16c9:	83 ec 08             	sub    $0x8,%esp
    16cc:	68 fe 4c 00 00       	push   $0x4cfe
    16d1:	6a 01                	push   $0x1
    16d3:	e8 cc 2a 00 00       	call   41a4 <printf>
...
linktest(void)
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    171e:	68 17 4d 00 00       	push   $0x4d17
  ...
  if(fd < 0){
    ...
    1737:	68 1f 4d 00 00       	push   $0x4d1f
    173c:	6a 01                	push   $0x1
    173e:	e8 61 2a 00 00       	call   41a4 <printf>
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    174e:	6a 05                	push   $0x5
    1750:	68 7b 4c 00 00       	push   $0x4c7b
    ...
    1768:	68 32 4d 00 00       	push   $0x4d32
    176d:	6a 01                	push   $0x1
    176f:	e8 30 2a 00 00       	call   41a4 <printf>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    178d:	68 1b 4d 00 00       	push   $0x4d1b
    1792:	68 17 4d 00 00       	push   $0x4d17
    ...
    17a6:	68 44 4d 00 00       	push   $0x4d44
    17ab:	6a 01                	push   $0x1
    17ad:	e8 f2 29 00 00       	call   41a4 <printf>
  ...
  unlink("lf1");
    ...
    17bd:	68 17 4d 00 00       	push   $0x4d17
  ...
  if(open("lf1", 0) >= 0){
    ...
    17cd:	6a 00                	push   $0x0
    17cf:	68 17 4d 00 00       	push   $0x4d17
    ...
    17e3:	68 5c 4d 00 00       	push   $0x4d5c
    17e8:	6a 01                	push   $0x1
    17ea:	e8 b5 29 00 00       	call   41a4 <printf>
  ...
  fd = open("lf2", 0);
    ...
    17fa:	6a 00                	push   $0x0
    17fc:	68 1b 4d 00 00       	push   $0x4d1b
  ...
  if(fd < 0){
    ...
    1815:	68 81 4d 00 00       	push   $0x4d81
    181a:	6a 01                	push   $0x1
    181c:	e8 83 29 00 00       	call   41a4 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1831:	68 e0 64 00 00       	push   $0x64e0
    ...
    1849:	68 92 4d 00 00       	push   $0x4d92
    184e:	6a 01                	push   $0x1
    1850:	e8 4f 29 00 00       	call   41a4 <printf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    186e:	68 1b 4d 00 00       	push   $0x4d1b
    1873:	68 1b 4d 00 00       	push   $0x4d1b
    ...
    1887:	68 a3 4d 00 00       	push   $0x4da3
    188c:	6a 01                	push   $0x1
    188e:	e8 11 29 00 00       	call   41a4 <printf>
  ...
  unlink("lf2");
    ...
    189e:	68 1b 4d 00 00       	push   $0x4d1b
    18a3:	e8 b0 27 00 00       	call   4058 <unlink>
    18a8:	83 c4 10             	add    $0x10,%esp
  if(link("lf2", "lf1") >= 0){
    18ab:	83 ec 08             	sub    $0x8,%esp
    18ae:	68 17 4d 00 00       	push   $0x4d17
    18b3:	68 1b 4d 00 00       	push   $0x4d1b
    ...
    18c7:	68 c4 4d 00 00       	push   $0x4dc4
    18cc:	6a 01                	push   $0x1
    18ce:	e8 d1 28 00 00       	call   41a4 <printf>
  ...
  if(link(".", "lf1") >= 0){
    ...
    18de:	68 17 4d 00 00       	push   $0x4d17
    18e3:	68 e7 4d 00 00       	push   $0x4de7
    ...
    18f7:	68 e9 4d 00 00       	push   $0x4de9
    18fc:	6a 01                	push   $0x1
    18fe:	e8 a1 28 00 00       	call   41a4 <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    190e:	68 05 4e 00 00       	push   $0x4e05
    1913:	6a 01                	push   $0x1
    1915:	e8 8a 28 00 00       	call   41a4 <printf>
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    192a:	68 12 4e 00 00       	push   $0x4e12
    192f:	6a 01                	push   $0x1
    1931:	e8 6e 28 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    199d:	50                   	push   %eax
    199e:	68 22 4e 00 00       	push   $0x4e22
    ...
    19e3:	50                   	push   %eax
    19e4:	68 22 4e 00 00       	push   $0x4e22
    ...
    1a16:	50                   	push   %eax
    1a17:	68 25 4e 00 00       	push   $0x4e25
    1a1c:	6a 01                	push   $0x1
    1a1e:	e8 81 27 00 00       	call   41a4 <printf>
  ...
  fd = open(".", 0);
    ...
    1a6d:	6a 00                	push   $0x0
    1a6f:	68 e7 4d 00 00       	push   $0x4de7
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acd:	50                   	push   %eax
    1ace:	68 41 4e 00 00       	push   $0x4e41
    1ad3:	6a 01                	push   $0x1
    1ad5:	e8 ca 26 00 00       	call   41a4 <printf>
    ...
    1afa:	50                   	push   %eax
    1afb:	68 5a 4e 00 00       	push   $0x4e5a
    1b00:	6a 01                	push   $0x1
    1b02:	e8 9d 26 00 00       	call   41a4 <printf>
  ...
  if(n != 40){
    ...
    1b51:	68 78 4e 00 00       	push   $0x4e78
    1b56:	6a 01                	push   $0x1
    1b58:	e8 47 26 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    1b8b:	68 fd 45 00 00       	push   $0x45fd
    1b90:	6a 01                	push   $0x1
    1b92:	e8 0d 26 00 00       	call   41a4 <printf>
  ...
  printf(1, "concreate ok\n");
    ...
    1cc5:	68 a9 4e 00 00       	push   $0x4ea9
    1cca:	6a 01                	push   $0x1
    1ccc:	e8 d3 24 00 00       	call   41a4 <printf>
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ce3:	68 b7 4e 00 00       	push   $0x4eb7
    1ce8:	6a 01                	push   $0x1
    1cea:	e8 b5 24 00 00       	call   41a4 <printf>
    1cef:	83 c4 10             	add    $0x10,%esp

  unlink("x");
    1cf2:	83 ec 0c             	sub    $0xc,%esp
    1cf5:	68 33 4a 00 00       	push   $0x4a33
  ...
  if(pid < 0){
    ...
    1d13:	68 fd 45 00 00       	push   $0x45fd
    1d18:	6a 01                	push   $0x1
    1d1a:	e8 85 24 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    1d7f:	68 33 4a 00 00       	push   $0x4a33
    ...
    1dbc:	68 33 4a 00 00       	push   $0x4a33
    1dc1:	68 c8 4e 00 00       	push   $0x4ec8
    ...
    1dd3:	68 33 4a 00 00       	push   $0x4a33
  ...
  printf(1, "linkunlink ok\n");
    ...
    1e03:	68 cc 4e 00 00       	push   $0x4ecc
    1e08:	6a 01                	push   $0x1
    1e0a:	e8 95 23 00 00       	call   41a4 <printf>
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1e1e:	68 db 4e 00 00       	push   $0x4edb
    1e23:	6a 01                	push   $0x1
    1e25:	e8 7a 23 00 00       	call   41a4 <printf>
    1e2a:	83 c4 10             	add    $0x10,%esp
  unlink("bd");
    1e2d:	83 ec 0c             	sub    $0xc,%esp
    1e30:	68 e8 4e 00 00       	push   $0x4ee8
  ...
  fd = open("bd", O_CREATE);
    ...
    1e45:	68 e8 4e 00 00       	push   $0x4ee8
  ...
  if(fd < 0){
    ...
    1e5e:	68 eb 4e 00 00       	push   $0x4eeb
    1e63:	6a 01                	push   $0x1
    1e65:	e8 3a 23 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ebf:	50                   	push   %eax
    1ec0:	68 e8 4e 00 00       	push   $0x4ee8
    ...
    1ed4:	68 01 4f 00 00       	push   $0x4f01
    1ed9:	6a 01                	push   $0x1
    1edb:	e8 c4 22 00 00       	call   41a4 <printf>
  ...
  unlink("bd");
    ...
    1ef8:	68 e8 4e 00 00       	push   $0x4ee8
  ...
  for(i = 0; i < 500; i++){
    ...
    1f54:	68 15 4f 00 00       	push   $0x4f15
    1f59:	6a 01                	push   $0x1
    1f5b:	e8 44 22 00 00       	call   41a4 <printf>
  ...
  printf(1, "bigdir ok\n");
    ...
    1f78:	68 2a 4f 00 00       	push   $0x4f2a
    1f7d:	6a 01                	push   $0x1
    1f7f:	e8 20 22 00 00       	call   41a4 <printf>
...
subdir(void)
{
  ...
  if(mkdir("dd") != 0){
    ...
    1fc9:	68 48 4f 00 00       	push   $0x4f48
    1fce:	6a 01                	push   $0x1
    1fd0:	e8 cf 21 00 00       	call   41a4 <printf>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fe5:	68 60 4f 00 00       	push   $0x4f60
  ...
  if(fd < 0){
    ...
    1ffe:	68 66 4f 00 00       	push   $0x4f66
    2003:	6a 01                	push   $0x1
    2005:	e8 9a 21 00 00       	call   41a4 <printf>
  ...
  write(fd, "ff", 2);
    ...
    2015:	6a 02                	push   $0x2
    2017:	68 42 4f 00 00       	push   $0x4f42
  ...
  if(unlink("dd") >= 0){
    ...
    2038:	68 45 4f 00 00       	push   $0x4f45
    ...
    204c:	68 7c 4f 00 00       	push   $0x4f7c
    2051:	6a 01                	push   $0x1
    2053:	e8 4c 21 00 00       	call   41a4 <printf>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2063:	68 a2 4f 00 00       	push   $0x4fa2
    ...
    2077:	68 a9 4f 00 00       	push   $0x4fa9
    207c:	6a 01                	push   $0x1
    207e:	e8 21 21 00 00       	call   41a4 <printf>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2093:	68 c4 4f 00 00       	push   $0x4fc4
  ...
  if(fd < 0){
    ...
    20ac:	68 cd 4f 00 00       	push   $0x4fcd
    20b1:	6a 01                	push   $0x1
    20b3:	e8 ec 20 00 00       	call   41a4 <printf>
  ...
  write(fd, "FF", 2);
    ...
    20c3:	6a 02                	push   $0x2
    20c5:	68 e5 4f 00 00       	push   $0x4fe5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20e6:	6a 00                	push   $0x0
    20e8:	68 e8 4f 00 00       	push   $0x4fe8
  ...
  if(fd < 0){
    ...
    2101:	68 f4 4f 00 00       	push   $0x4ff4
    2106:	6a 01                	push   $0x1
    2108:	e8 97 20 00 00       	call   41a4 <printf>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    211d:	68 e0 64 00 00       	push   $0x64e0
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2136:	0f b6 05 e0 64 00 00 	movzbl 0x64e0,%eax
    213d:	3c 66                	cmp    $0x66,%al
    213f:	74 17                	je     2158 <subdir+0x1ce>
    printf(1, "dd/dd/../ff wrong content\n");
    2141:	83 ec 08             	sub    $0x8,%esp
    2144:	68 0d 50 00 00       	push   $0x500d
    2149:	6a 01                	push   $0x1
    214b:	e8 54 20 00 00       	call   41a4 <printf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2169:	68 28 50 00 00       	push   $0x5028
    216e:	68 c4 4f 00 00       	push   $0x4fc4
    ...
    2182:	68 34 50 00 00       	push   $0x5034
    2187:	6a 01                	push   $0x1
    2189:	e8 16 20 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2199:	68 c4 4f 00 00       	push   $0x4fc4
    ...
    21ad:	68 55 50 00 00       	push   $0x5055
    21b2:	6a 01                	push   $0x1
    21b4:	e8 eb 1f 00 00       	call   41a4 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21c4:	6a 00                	push   $0x0
    21c6:	68 c4 4f 00 00       	push   $0x4fc4
    ...
    21da:	68 70 50 00 00       	push   $0x5070
    21df:	6a 01                	push   $0x1
    21e1:	e8 be 1f 00 00       	call   41a4 <printf>
  ...
  if(chdir("dd") != 0){
    ...
    21f1:	68 45 4f 00 00       	push   $0x4f45
    ...
    2205:	68 94 50 00 00       	push   $0x5094
    220a:	6a 01                	push   $0x1
    220c:	e8 93 1f 00 00       	call   41a4 <printf>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    221c:	68 a5 50 00 00       	push   $0x50a5
    ...
    2230:	68 b1 50 00 00       	push   $0x50b1
    2235:	6a 01                	push   $0x1
    2237:	e8 68 1f 00 00       	call   41a4 <printf>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2247:	68 cb 50 00 00       	push   $0x50cb
    ...
    225b:	68 b1 50 00 00       	push   $0x50b1
    2260:	6a 01                	push   $0x1
    2262:	e8 3d 1f 00 00       	call   41a4 <printf>
  ...
  if(chdir("./..") != 0){
    ...
    2272:	68 da 50 00 00       	push   $0x50da
    ...
    2286:	68 df 50 00 00       	push   $0x50df
    228b:	6a 01                	push   $0x1
    228d:	e8 12 1f 00 00       	call   41a4 <printf>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    229d:	6a 00                	push   $0x0
    229f:	68 28 50 00 00       	push   $0x5028
  ...
  if(fd < 0){
    ...
    22b8:	68 f2 50 00 00       	push   $0x50f2
    22bd:	6a 01                	push   $0x1
    22bf:	e8 e0 1e 00 00       	call   41a4 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22d4:	68 e0 64 00 00       	push   $0x64e0
    ...
    22ec:	68 0a 51 00 00       	push   $0x510a
    22f1:	6a 01                	push   $0x1
    22f3:	e8 ac 1e 00 00       	call   41a4 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2311:	6a 00                	push   $0x0
    2313:	68 c4 4f 00 00       	push   $0x4fc4
    ...
    2327:	68 28 51 00 00       	push   $0x5128
    232c:	6a 01                	push   $0x1
    232e:	e8 71 1e 00 00       	call   41a4 <printf>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2343:	68 4d 51 00 00       	push   $0x514d
    ...
    2357:	68 56 51 00 00       	push   $0x5156
    235c:	6a 01                	push   $0x1
    235e:	e8 41 1e 00 00       	call   41a4 <printf>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2373:	68 72 51 00 00       	push   $0x5172
    ...
    2387:	68 7b 51 00 00       	push   $0x517b
    238c:	6a 01                	push   $0x1
    238e:	e8 11 1e 00 00       	call   41a4 <printf>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    23a3:	68 45 4f 00 00       	push   $0x4f45
    ...
    23b7:	68 97 51 00 00       	push   $0x5197
    23bc:	6a 01                	push   $0x1
    23be:	e8 e1 1d 00 00       	call   41a4 <printf>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23ce:	6a 02                	push   $0x2
    23d0:	68 45 4f 00 00       	push   $0x4f45
    ...
    23e4:	68 ad 51 00 00       	push   $0x51ad
    23e9:	6a 01                	push   $0x1
    23eb:	e8 b4 1d 00 00       	call   41a4 <printf>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    23fb:	6a 01                	push   $0x1
    23fd:	68 45 4f 00 00       	push   $0x4f45
    ...
    2411:	68 c6 51 00 00       	push   $0x51c6
    2416:	6a 01                	push   $0x1
    2418:	e8 87 1d 00 00       	call   41a4 <printf>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2428:	68 e1 51 00 00       	push   $0x51e1
    242d:	68 4d 51 00 00       	push   $0x514d
    ...
    2441:	68 ec 51 00 00       	push   $0x51ec
    2446:	6a 01                	push   $0x1
    2448:	e8 57 1d 00 00       	call   41a4 <printf>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2458:	68 e1 51 00 00       	push   $0x51e1
    245d:	68 72 51 00 00       	push   $0x5172
    ...
    2471:	68 10 52 00 00       	push   $0x5210
    2476:	6a 01                	push   $0x1
    2478:	e8 27 1d 00 00       	call   41a4 <printf>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2488:	68 28 50 00 00       	push   $0x5028
    248d:	68 60 4f 00 00       	push   $0x4f60
    ...
    24a1:	68 34 52 00 00       	push   $0x5234
    24a6:	6a 01                	push   $0x1
    24a8:	e8 f7 1c 00 00       	call   41a4 <printf>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24b8:	68 4d 51 00 00       	push   $0x514d
    ...
    24cc:	68 56 52 00 00       	push   $0x5256
    24d1:	6a 01                	push   $0x1
    24d3:	e8 cc 1c 00 00       	call   41a4 <printf>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24e3:	68 72 51 00 00       	push   $0x5172
    ...
    24f7:	68 71 52 00 00       	push   $0x5271
    24fc:	6a 01                	push   $0x1
    24fe:	e8 a1 1c 00 00       	call   41a4 <printf>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    250e:	68 28 50 00 00       	push   $0x5028
    ...
    2522:	68 8c 52 00 00       	push   $0x528c
    2527:	6a 01                	push   $0x1
    2529:	e8 76 1c 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2539:	68 72 51 00 00       	push   $0x5172
    ...
    254d:	68 a9 52 00 00       	push   $0x52a9
    2552:	6a 01                	push   $0x1
    2554:	e8 4b 1c 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2564:	68 4d 51 00 00       	push   $0x514d
    ...
    2578:	68 c5 52 00 00       	push   $0x52c5
    257d:	6a 01                	push   $0x1
    257f:	e8 20 1c 00 00       	call   41a4 <printf>
  ...
  if(chdir("dd/ff") == 0){
    ...
    258f:	68 60 4f 00 00       	push   $0x4f60
    ...
    25a3:	68 e1 52 00 00       	push   $0x52e1
    25a8:	6a 01                	push   $0x1
    25aa:	e8 f5 1b 00 00       	call   41a4 <printf>
  ...
  if(chdir("dd/xx") == 0){
    ...
    25ba:	68 f9 52 00 00       	push   $0x52f9
    ...
    25ce:	68 ff 52 00 00       	push   $0x52ff
    25d3:	6a 01                	push   $0x1
    25d5:	e8 ca 1b 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25e5:	68 28 50 00 00       	push   $0x5028
    ...
    25f9:	68 55 50 00 00       	push   $0x5055
    25fe:	6a 01                	push   $0x1
    2600:	e8 9f 1b 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2610:	68 60 4f 00 00       	push   $0x4f60
    ...
    2624:	68 17 53 00 00       	push   $0x5317
    2629:	6a 01                	push   $0x1
    262b:	e8 74 1b 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd") == 0){
    ...
    263b:	68 45 4f 00 00       	push   $0x4f45
    ...
    264f:	68 2c 53 00 00       	push   $0x532c
    2654:	6a 01                	push   $0x1
    2656:	e8 49 1b 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2666:	68 4c 53 00 00       	push   $0x534c
    ...
    267a:	68 52 53 00 00       	push   $0x5352
    267f:	6a 01                	push   $0x1
    2681:	e8 1e 1b 00 00       	call   41a4 <printf>
  ...
  if(unlink("dd") < 0){
    ...
    2691:	68 45 4f 00 00       	push   $0x4f45
    ...
    26a5:	68 67 53 00 00       	push   $0x5367
    26aa:	6a 01                	push   $0x1
    26ac:	e8 f3 1a 00 00       	call   41a4 <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    26bc:	68 79 53 00 00       	push   $0x5379
    26c1:	6a 01                	push   $0x1
    26c3:	e8 dc 1a 00 00       	call   41a4 <printf>
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26d7:	68 84 53 00 00       	push   $0x5384
    26dc:	6a 01                	push   $0x1
    26de:	e8 c1 1a 00 00       	call   41a4 <printf>
    26e3:	83 c4 10             	add    $0x10,%esp

  unlink("bigwrite");
    26e6:	83 ec 0c             	sub    $0xc,%esp
    26e9:	68 93 53 00 00       	push   $0x5393
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    270a:	68 93 53 00 00       	push   $0x5393
    ...
    2723:	68 9c 53 00 00       	push   $0x539c
    2728:	6a 01                	push   $0x1
    272a:	e8 75 1a 00 00       	call   41a4 <printf>
    ...
    2746:	68 e0 64 00 00       	push   $0x64e0
    ...
    2767:	68 b4 53 00 00       	push   $0x53b4
    276c:	6a 01                	push   $0x1
    276e:	e8 31 1a 00 00       	call   41a4 <printf>
    ...
    2796:	68 93 53 00 00       	push   $0x5393
  ...
  printf(1, "bigwrite ok\n");
    ...
    27ba:	68 c6 53 00 00       	push   $0x53c6
    27bf:	6a 01                	push   $0x1
    27c1:	e8 de 19 00 00       	call   41a4 <printf>
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27d5:	68 d3 53 00 00       	push   $0x53d3
    27da:	6a 01                	push   $0x1
    27dc:	e8 c3 19 00 00       	call   41a4 <printf>
    27e1:	83 c4 10             	add    $0x10,%esp

  unlink("bigfile");
    27e4:	83 ec 0c             	sub    $0xc,%esp
    27e7:	68 e1 53 00 00       	push   $0x53e1
  ...
  fd = open("bigfile", O_CREATE | O_RDWR);
    ...
    27fc:	68 e1 53 00 00       	push   $0x53e1
  ...
  if(fd < 0){
    ...
    2815:	68 e9 53 00 00       	push   $0x53e9
    281a:	6a 01                	push   $0x1
    281c:	e8 83 19 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    283d:	68 e0 64 00 00       	push   $0x64e0
    ...
    2852:	68 e0 64 00 00       	push   $0x64e0
    ...
    286c:	68 ff 53 00 00       	push   $0x53ff
    2871:	6a 01                	push   $0x1
    2873:	e8 2c 19 00 00       	call   41a4 <printf>
  ...
  fd = open("bigfile", 0);
    ...
    289b:	6a 00                	push   $0x0
    289d:	68 e1 53 00 00       	push   $0x53e1
  ...
  if(fd < 0){
    ...
    28b6:	68 15 54 00 00       	push   $0x5415
    28bb:	6a 01                	push   $0x1
    28bd:	e8 e2 18 00 00       	call   41a4 <printf>
  ...
  for(i = 0; ; i++){
    ...
    28e0:	68 e0 64 00 00       	push   $0x64e0
    ...
    28fc:	68 2a 54 00 00       	push   $0x542a
    2901:	6a 01                	push   $0x1
    2903:	e8 9c 18 00 00       	call   41a4 <printf>
    ...
    2922:	68 3f 54 00 00       	push   $0x543f
    2927:	6a 01                	push   $0x1
    2929:	e8 76 18 00 00       	call   41a4 <printf>
    292e:	83 c4 10             	add    $0x10,%esp
      exit();
    2931:	e8 d2 16 00 00       	call   4008 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    2936:	0f b6 05 e0 64 00 00 	movzbl 0x64e0,%eax
    ...
    2950:	0f b6 05 0b 66 00 00 	movzbl 0x660b,%eax
    ...
    296d:	68 53 54 00 00       	push   $0x5453
    2972:	6a 01                	push   $0x1
    2974:	e8 2b 18 00 00       	call   41a4 <printf>
  ...
  if(total != 20*600){
    ...
    29ab:	68 6c 54 00 00       	push   $0x546c
    29b0:	6a 01                	push   $0x1
    29b2:	e8 ed 17 00 00       	call   41a4 <printf>
  ...
  unlink("bigfile");
    ...
    29c2:	68 e1 53 00 00       	push   $0x53e1
    29c7:	e8 8c 16 00 00       	call   4058 <unlink>
    29cc:	83 c4 10             	add    $0x10,%esp

  printf(1, "bigfile test ok\n");
    29cf:	83 ec 08             	sub    $0x8,%esp
    29d2:	68 86 54 00 00       	push   $0x5486
    29d7:	6a 01                	push   $0x1
    29d9:	e8 c6 17 00 00       	call   41a4 <printf>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29ed:	68 97 54 00 00       	push   $0x5497
    29f2:	6a 01                	push   $0x1
    29f4:	e8 ab 17 00 00       	call   41a4 <printf>
    29f9:	83 c4 10             	add    $0x10,%esp

  if(mkdir("12345678901234") != 0){
    29fc:	83 ec 0c             	sub    $0xc,%esp
    29ff:	68 a6 54 00 00       	push   $0x54a6
    ...
    2a13:	68 b5 54 00 00       	push   $0x54b5
    2a18:	6a 01                	push   $0x1
    2a1a:	e8 85 17 00 00       	call   41a4 <printf>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a2a:	68 d4 54 00 00       	push   $0x54d4
    ...
    2a3e:	68 f4 54 00 00       	push   $0x54f4
    2a43:	6a 01                	push   $0x1
    2a45:	e8 5a 17 00 00       	call   41a4 <printf>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a5a:	68 24 55 00 00       	push   $0x5524
  ...
  if(fd < 0){
    ...
    2a73:	68 54 55 00 00       	push   $0x5554
    2a78:	6a 01                	push   $0x1
    2a7a:	e8 25 17 00 00       	call   41a4 <printf>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a98:	6a 00                	push   $0x0
    2a9a:	68 94 55 00 00       	push   $0x5594
  ...
  if(fd < 0){
    ...
    2ab3:	68 c4 55 00 00       	push   $0x55c4
    2ab8:	6a 01                	push   $0x1
    2aba:	e8 e5 16 00 00       	call   41a4 <printf>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ad8:	68 fe 55 00 00       	push   $0x55fe
    ...
    2aec:	68 1c 56 00 00       	push   $0x561c
    2af1:	6a 01                	push   $0x1
    2af3:	e8 ac 16 00 00       	call   41a4 <printf>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2b03:	68 4c 56 00 00       	push   $0x564c
    ...
    2b17:	68 6c 56 00 00       	push   $0x566c
    2b1c:	6a 01                	push   $0x1
    2b1e:	e8 81 16 00 00       	call   41a4 <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    2b2e:	68 9d 56 00 00       	push   $0x569d
    2b33:	6a 01                	push   $0x1
    2b35:	e8 6a 16 00 00       	call   41a4 <printf>
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b49:	68 aa 56 00 00       	push   $0x56aa
    2b4e:	6a 01                	push   $0x1
    2b50:	e8 4f 16 00 00       	call   41a4 <printf>
    2b55:	83 c4 10             	add    $0x10,%esp
  if(mkdir("dots") != 0){
    2b58:	83 ec 0c             	sub    $0xc,%esp
    2b5b:	68 b6 56 00 00       	push   $0x56b6
    ...
    2b6f:	68 bb 56 00 00       	push   $0x56bb
    2b74:	6a 01                	push   $0x1
    2b76:	e8 29 16 00 00       	call   41a4 <printf>
  ...
  if(chdir("dots") != 0){
    ...
    2b86:	68 b6 56 00 00       	push   $0x56b6
    ...
    2b9a:	68 ce 56 00 00       	push   $0x56ce
    2b9f:	6a 01                	push   $0x1
    2ba1:	e8 fe 15 00 00       	call   41a4 <printf>
  ...
  if(unlink(".") == 0){
    ...
    2bb1:	68 e7 4d 00 00       	push   $0x4de7
    ...
    2bc5:	68 e1 56 00 00       	push   $0x56e1
    2bca:	6a 01                	push   $0x1
    2bcc:	e8 d3 15 00 00       	call   41a4 <printf>
  ...
  if(unlink("..") == 0){
    ...
    2bdc:	68 7a 49 00 00       	push   $0x497a
    ...
    2bf0:	68 ef 56 00 00       	push   $0x56ef
    2bf5:	6a 01                	push   $0x1
    2bf7:	e8 a8 15 00 00       	call   41a4 <printf>
  ...
  if(chdir("/") != 0){
    ...
    2c07:	68 ce 45 00 00       	push   $0x45ce
    ...
    2c1b:	68 d0 45 00 00       	push   $0x45d0
    2c20:	6a 01                	push   $0x1
    2c22:	e8 7d 15 00 00       	call   41a4 <printf>
  ...
  if(unlink("dots/.") == 0){
    ...
    2c32:	68 fe 56 00 00       	push   $0x56fe
    ...
    2c46:	68 05 57 00 00       	push   $0x5705
    2c4b:	6a 01                	push   $0x1
    2c4d:	e8 52 15 00 00       	call   41a4 <printf>
  ...
  if(unlink("dots/..") == 0){
    ...
    2c5d:	68 1c 57 00 00       	push   $0x571c
    ...
    2c71:	68 24 57 00 00       	push   $0x5724
    2c76:	6a 01                	push   $0x1
    2c78:	e8 27 15 00 00       	call   41a4 <printf>
  ...
  if(unlink("dots") != 0){
    ...
    2c88:	68 b6 56 00 00       	push   $0x56b6
    ...
    2c9c:	68 3c 57 00 00       	push   $0x573c
    2ca1:	6a 01                	push   $0x1
    2ca3:	e8 fc 14 00 00       	call   41a4 <printf>
  ...
  printf(1, "rmdot ok\n");
    ...
    2cb3:	68 51 57 00 00       	push   $0x5751
    2cb8:	6a 01                	push   $0x1
    2cba:	e8 e5 14 00 00       	call   41a4 <printf>
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2cce:	68 5b 57 00 00       	push   $0x575b
    2cd3:	6a 01                	push   $0x1
    2cd5:	e8 ca 14 00 00       	call   41a4 <printf>
    2cda:	83 c4 10             	add    $0x10,%esp

  fd = open("dirfile", O_CREATE);
    2cdd:	83 ec 08             	sub    $0x8,%esp
    2ce0:	68 00 02 00 00       	push   $0x200
    2ce5:	68 68 57 00 00       	push   $0x5768
  ...
  if(fd < 0){
    ...
    2cfe:	68 70 57 00 00       	push   $0x5770
    2d03:	6a 01                	push   $0x1
    2d05:	e8 9a 14 00 00       	call   41a4 <printf>
  ...
  if(chdir("dirfile") == 0){
    ...
    2d23:	68 68 57 00 00       	push   $0x5768
    ...
    2d37:	68 87 57 00 00       	push   $0x5787
    2d3c:	6a 01                	push   $0x1
    2d3e:	e8 61 14 00 00       	call   41a4 <printf>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d4e:	6a 00                	push   $0x0
    2d50:	68 a1 57 00 00       	push   $0x57a1
  ...
  if(fd >= 0){
    ...
    2d69:	68 ac 57 00 00       	push   $0x57ac
    2d6e:	6a 01                	push   $0x1
    2d70:	e8 2f 14 00 00       	call   41a4 <printf>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d85:	68 a1 57 00 00       	push   $0x57a1
  ...
  if(fd >= 0){
    ...
    2d9e:	68 ac 57 00 00       	push   $0x57ac
    2da3:	6a 01                	push   $0x1
    2da5:	e8 fa 13 00 00       	call   41a4 <printf>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2db5:	68 a1 57 00 00       	push   $0x57a1
    ...
    2dc9:	68 ca 57 00 00       	push   $0x57ca
    2dce:	6a 01                	push   $0x1
    2dd0:	e8 cf 13 00 00       	call   41a4 <printf>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2de0:	68 a1 57 00 00       	push   $0x57a1
    ...
    2df4:	68 e7 57 00 00       	push   $0x57e7
    2df9:	6a 01                	push   $0x1
    2dfb:	e8 a4 13 00 00       	call   41a4 <printf>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e0b:	68 a1 57 00 00       	push   $0x57a1
    2e10:	68 05 58 00 00       	push   $0x5805
    ...
    2e24:	68 0c 58 00 00       	push   $0x580c
    2e29:	6a 01                	push   $0x1
    2e2b:	e8 74 13 00 00       	call   41a4 <printf>
  ...
  if(unlink("dirfile") != 0){
    ...
    2e3b:	68 68 57 00 00       	push   $0x5768
    ...
    2e4f:	68 2b 58 00 00       	push   $0x582b
    2e54:	6a 01                	push   $0x1
    2e56:	e8 49 13 00 00       	call   41a4 <printf>
  ...
  fd = open(".", O_RDWR);
    ...
    2e66:	6a 02                	push   $0x2
    2e68:	68 e7 4d 00 00       	push   $0x4de7
  ...
  if(fd >= 0){
    ...
    2e81:	68 44 58 00 00       	push   $0x5844
    2e86:	6a 01                	push   $0x1
    2e88:	e8 17 13 00 00       	call   41a4 <printf>
  ...
  fd = open(".", 0);
    ...
    2e98:	6a 00                	push   $0x0
    2e9a:	68 e7 4d 00 00       	push   $0x4de7
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ead:	6a 01                	push   $0x1
    2eaf:	68 33 4a 00 00       	push   $0x4a33
    ...
    2ec6:	68 63 58 00 00       	push   $0x5863
    2ecb:	6a 01                	push   $0x1
    2ecd:	e8 d2 12 00 00       	call   41a4 <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    2eeb:	68 77 58 00 00       	push   $0x5877
    2ef0:	6a 01                	push   $0x1
    2ef2:	e8 ad 12 00 00       	call   41a4 <printf>
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2f06:	68 87 58 00 00       	push   $0x5887
    2f0b:	6a 01                	push   $0x1
    2f0d:	e8 92 12 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f24:	68 98 58 00 00       	push   $0x5898
    ...
    2f38:	68 9e 58 00 00       	push   $0x589e
    2f3d:	6a 01                	push   $0x1
    2f3f:	e8 60 12 00 00       	call   41a4 <printf>
    ...
    2f4f:	68 98 58 00 00       	push   $0x5898
    ...
    2f63:	68 b2 58 00 00       	push   $0x58b2
    2f68:	6a 01                	push   $0x1
    2f6a:	e8 35 12 00 00       	call   41a4 <printf>
    ...
    2fd0:	68 c7 58 00 00       	push   $0x58c7
    ...
    2ff7:	68 c7 58 00 00       	push   $0x58c7
  ...
  chdir("/");
    ...
    3015:	68 ce 45 00 00       	push   $0x45ce
    301a:	e8 59 10 00 00       	call   4078 <chdir>
    301f:	83 c4 10             	add    $0x10,%esp
  printf(1, "empty file name OK\n");
    3022:	83 ec 08             	sub    $0x8,%esp
    3025:	68 ca 58 00 00       	push   $0x58ca
    302a:	6a 01                	push   $0x1
    302c:	e8 73 11 00 00       	call   41a4 <printf>
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3040:	68 de 58 00 00       	push   $0x58de
    3045:	6a 01                	push   $0x1
    3047:	e8 58 11 00 00       	call   41a4 <printf>
  ...
  if(n == 1000){
    ...
    308d:	68 ec 58 00 00       	push   $0x58ec
    3092:	6a 01                	push   $0x1
    3094:	e8 0b 11 00 00       	call   41a4 <printf>
  ...
  for(; n > 0; n--){
    ...
    30ad:	68 0e 59 00 00       	push   $0x590e
    30b2:	6a 01                	push   $0x1
    30b4:	e8 eb 10 00 00       	call   41a4 <printf>
  ...
  if(wait() != -1){
    ...
    30d8:	68 22 59 00 00       	push   $0x5922
    30dd:	6a 01                	push   $0x1
    30df:	e8 c0 10 00 00       	call   41a4 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    30ef:	68 35 59 00 00       	push   $0x5935
    30f4:	6a 01                	push   $0x1
    30f6:	e8 a9 10 00 00       	call   41a4 <printf>
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3107:	a1 b4 64 00 00       	mov    0x64b4,%eax
    310c:	83 ec 08             	sub    $0x8,%esp
    310f:	68 43 59 00 00       	push   $0x5943
    3114:	50                   	push   %eax
    3115:	e8 8a 10 00 00       	call   41a4 <printf>
  ...
  if(pid < 0){
    ...
    31ac:	a1 b4 64 00 00       	mov    0x64b4,%eax
    31b1:	83 ec 08             	sub    $0x8,%esp
    31b4:	68 69 59 00 00       	push   $0x5969
    31b9:	50                   	push   %eax
    31ba:	e8 e5 0f 00 00       	call   41a4 <printf>
  ...
  if(c != a + 1){
    ...
    31f2:	a1 b4 64 00 00       	mov    0x64b4,%eax
    31f7:	83 ec 08             	sub    $0x8,%esp
    31fa:	68 80 59 00 00       	push   $0x5980
    31ff:	50                   	push   %eax
    3200:	e8 9f 0f 00 00       	call   41a4 <printf>
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    3254:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3259:	83 ec 08             	sub    $0x8,%esp
    325c:	68 9c 59 00 00       	push   $0x599c
    3261:	50                   	push   %eax
    3262:	e8 3d 0f 00 00       	call   41a4 <printf>
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    32a5:	a1 b4 64 00 00       	mov    0x64b4,%eax
    32aa:	83 ec 08             	sub    $0x8,%esp
    32ad:	68 da 59 00 00       	push   $0x59da
    32b2:	50                   	push   %eax
    32b3:	e8 ec 0e 00 00       	call   41a4 <printf>
  ...
  if(c != a - 4096){
    ...
    32dd:	a1 b4 64 00 00       	mov    0x64b4,%eax
    32e2:	ff 75 e4             	push   -0x1c(%ebp)
    32e5:	ff 75 f4             	push   -0xc(%ebp)
    32e8:	68 f8 59 00 00       	push   $0x59f8
    32ed:	50                   	push   %eax
    32ee:	e8 b1 0e 00 00       	call   41a4 <printf>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3340:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3345:	ff 75 e4             	push   -0x1c(%ebp)
    3348:	ff 75 f4             	push   -0xc(%ebp)
    334b:	68 30 5a 00 00       	push   $0x5a30
    3350:	50                   	push   %eax
    3351:	e8 4e 0e 00 00       	call   41a4 <printf>
  ...
  if(*lastaddr == 99){
    ...
    3368:	a1 b4 64 00 00       	mov    0x64b4,%eax
    336d:	83 ec 08             	sub    $0x8,%esp
    3370:	68 58 5a 00 00       	push   $0x5a58
    3375:	50                   	push   %eax
    3376:	e8 29 0e 00 00       	call   41a4 <printf>
  ...
  if(c != a){
    ...
    33be:	a1 b4 64 00 00       	mov    0x64b4,%eax
    33c3:	ff 75 e4             	push   -0x1c(%ebp)
    33c6:	ff 75 f4             	push   -0xc(%ebp)
    33c9:	68 88 5a 00 00       	push   $0x5a88
    33ce:	50                   	push   %eax
    33cf:	e8 d0 0d 00 00       	call   41a4 <printf>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33f9:	79 1b                	jns    3416 <sbrktest+0x315>
      printf(stdout, "fork failed\n");
    33fb:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3400:	83 ec 08             	sub    $0x8,%esp
    3403:	68 fd 45 00 00       	push   $0x45fd
    3408:	50                   	push   %eax
    3409:	e8 96 0d 00 00       	call   41a4 <printf>
    ...
    3425:	a1 b4 64 00 00       	mov    0x64b4,%eax
    342a:	52                   	push   %edx
    342b:	ff 75 f4             	push   -0xc(%ebp)
    342e:	68 a9 5a 00 00       	push   $0x5aa9
    3433:	50                   	push   %eax
    3434:	e8 6b 0d 00 00       	call   41a4 <printf>
  ...
  if(pipe(fds) != 0){
    ...
    347a:	68 ce 49 00 00       	push   $0x49ce
    347f:	6a 01                	push   $0x1
    3481:	e8 1e 0d 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d9:	6a 01                	push   $0x1
    34db:	68 33 4a 00 00       	push   $0x4a33
    34e0:	50                   	push   %eax
  ...
  if(c == (char*)0xffffffff){
    ...
    3581:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3586:	83 ec 08             	sub    $0x8,%esp
    3589:	68 c2 5a 00 00       	push   $0x5ac2
    358e:	50                   	push   %eax
    358f:	e8 10 0c 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "sbrk test OK\n");
    35ce:	a1 b4 64 00 00       	mov    0x64b4,%eax
    35d3:	83 ec 08             	sub    $0x8,%esp
    35d6:	68 dd 5a 00 00       	push   $0x5add
    35db:	50                   	push   %eax
    35dc:	e8 c3 0b 00 00       	call   41a4 <printf>
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    360f:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3614:	83 ec 08             	sub    $0x8,%esp
    3617:	68 eb 5a 00 00       	push   $0x5aeb
    361c:	50                   	push   %eax
    361d:	e8 82 0b 00 00       	call   41a4 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    368d:	50                   	push   %eax
    368e:	68 fa 5a 00 00       	push   $0x5afa
    ...
    36a0:	a1 b4 64 00 00       	mov    0x64b4,%eax
    36a5:	83 ec 08             	sub    $0x8,%esp
    36a8:	68 05 5b 00 00       	push   $0x5b05
    36ad:	50                   	push   %eax
    36ae:	e8 f1 0a 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "validate ok\n");
    36ce:	a1 b4 64 00 00       	mov    0x64b4,%eax
    36d3:	83 ec 08             	sub    $0x8,%esp
    36d6:	68 1e 5b 00 00       	push   $0x5b1e
    36db:	50                   	push   %eax
    36dc:	e8 c3 0a 00 00       	call   41a4 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36ed:	a1 b4 64 00 00       	mov    0x64b4,%eax
    36f2:	83 ec 08             	sub    $0x8,%esp
    36f5:	68 2b 5b 00 00       	push   $0x5b2b
    36fa:	50                   	push   %eax
    36fb:	e8 a4 0a 00 00       	call   41a4 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    370f:	05 00 85 00 00       	add    $0x8500,%eax
    3714:	0f b6 00             	movzbl (%eax),%eax
    3717:	84 c0                	test   %al,%al
    3719:	74 1b                	je     3736 <bsstest+0x4f>
      printf(stdout, "bss test failed\n");
    371b:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3720:	83 ec 08             	sub    $0x8,%esp
    3723:	68 35 5b 00 00       	push   $0x5b35
    3728:	50                   	push   %eax
    3729:	e8 76 0a 00 00       	call   41a4 <printf>
  ...
  printf(stdout, "bss test ok\n");
    3744:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3749:	83 ec 08             	sub    $0x8,%esp
    374c:	68 46 5b 00 00       	push   $0x5b46
    3751:	50                   	push   %eax
    3752:	e8 4d 0a 00 00       	call   41a4 <printf>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3766:	68 53 5b 00 00       	push   $0x5b53
  ...
  if(pid == 0){
    ...
    3791:	c7 04 85 20 ac 00 00 	movl   $0x5b60,0xac20(,%eax,4)
    3798:	60 5b 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    args[MAXARG-1] = 0;
    37a6:	c7 05 9c ac 00 00 00 	movl   $0x0,0xac9c
    37ad:	00 00 00 
    printf(stdout, "bigarg test\n");
    37b0:	a1 b4 64 00 00       	mov    0x64b4,%eax
    37b5:	83 ec 08             	sub    $0x8,%esp
    37b8:	68 3d 5c 00 00       	push   $0x5c3d
    37bd:	50                   	push   %eax
    37be:	e8 e1 09 00 00       	call   41a4 <printf>
    37c3:	83 c4 10             	add    $0x10,%esp
    exec("echo", args);
    37c6:	83 ec 08             	sub    $0x8,%esp
    37c9:	68 20 ac 00 00       	push   $0xac20
    37ce:	68 5c 45 00 00       	push   $0x455c
    37d3:	e8 68 08 00 00       	call   4040 <exec>
    37d8:	83 c4 10             	add    $0x10,%esp
    printf(stdout, "bigarg test ok\n");
    37db:	a1 b4 64 00 00       	mov    0x64b4,%eax
    37e0:	83 ec 08             	sub    $0x8,%esp
    37e3:	68 4a 5c 00 00       	push   $0x5c4a
    37e8:	50                   	push   %eax
    37e9:	e8 b6 09 00 00       	call   41a4 <printf>
    37ee:	83 c4 10             	add    $0x10,%esp
    fd = open("bigarg-ok", O_CREATE);
    37f1:	83 ec 08             	sub    $0x8,%esp
    37f4:	68 00 02 00 00       	push   $0x200
    37f9:	68 53 5b 00 00       	push   $0x5b53
    ...
    3822:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3827:	83 ec 08             	sub    $0x8,%esp
    382a:	68 5a 5c 00 00       	push   $0x5c5a
    382f:	50                   	push   %eax
    3830:	e8 6f 09 00 00       	call   41a4 <printf>
  ...
  fd = open("bigarg-ok", 0);
    ...
    3845:	6a 00                	push   $0x0
    3847:	68 53 5b 00 00       	push   $0x5b53
  ...
  if(fd < 0){
    ...
    385d:	a1 b4 64 00 00       	mov    0x64b4,%eax
    3862:	83 ec 08             	sub    $0x8,%esp
    3865:	68 73 5c 00 00       	push   $0x5c73
    386a:	50                   	push   %eax
    386b:	e8 34 09 00 00       	call   41a4 <printf>
  ...
  unlink("bigarg-ok");
    ...
    3889:	68 53 5b 00 00       	push   $0x5b53
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    38aa:	68 88 5c 00 00       	push   $0x5c88
    38af:	6a 01                	push   $0x1
    38b1:	e8 ee 08 00 00       	call   41a4 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3996:	50                   	push   %eax
    3997:	68 95 5c 00 00       	push   $0x5c95
    399c:	6a 01                	push   $0x1
    399e:	e8 01 08 00 00       	call   41a4 <printf>
    ...
    39c9:	50                   	push   %eax
    39ca:	68 a1 5c 00 00       	push   $0x5ca1
    39cf:	6a 01                	push   $0x1
    39d1:	e8 ce 07 00 00       	call   41a4 <printf>
    ...
    39ea:	68 e0 64 00 00       	push   $0x64e0
    ...
    3a19:	68 b1 5c 00 00       	push   $0x5cb1
    3a1e:	6a 01                	push   $0x1
    3a20:	e8 7f 07 00 00       	call   41a4 <printf>
  ...
  printf(1, "fsfull test finished\n");
    ...
    3b3b:	68 c1 5c 00 00       	push   $0x5cc1
    3b40:	6a 01                	push   $0x1
    3b42:	e8 5d 06 00 00       	call   41a4 <printf>
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3b63:	68 d7 5c 00 00       	push   $0x5cd7
    3b68:	6a 01                	push   $0x1
    3b6a:	e8 35 06 00 00       	call   41a4 <printf>
  ...
  if(pid == 0){
    ...
    3ba6:	68 e4 5c 00 00       	push   $0x5ce4
    3bab:	6a 01                	push   $0x1
    3bad:	e8 f2 05 00 00       	call   41a4 <printf>
    ...
    3bc3:	68 fd 45 00 00       	push   $0x45fd
    3bc8:	6a 01                	push   $0x1
    3bca:	e8 d5 05 00 00       	call   41a4 <printf>
  ...
  printf(1, "uio test done\n");
    ...
    3bdf:	68 05 5d 00 00       	push   $0x5d05
    3be4:	6a 01                	push   $0x1
    3be6:	e8 b9 05 00 00       	call   41a4 <printf>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bfa:	6a 00                	push   $0x0
    3bfc:	68 14 5d 00 00       	push   $0x5d14
  ...
  if (fd < 0) {
    ...
    3c15:	68 19 5d 00 00       	push   $0x5d19
    3c1a:	6a 02                	push   $0x2
    3c1c:	e8 83 05 00 00       	call   41a4 <printf>
  ...
  printf(1, "arg test passed\n");
    ...
    3c5b:	68 26 5d 00 00       	push   $0x5d26
    3c60:	6a 01                	push   $0x1
    3c62:	e8 3d 05 00 00       	call   41a4 <printf>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c70:	a1 b8 64 00 00       	mov    0x64b8,%eax
    3c75:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c7b:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c80:	a3 b8 64 00 00       	mov    %eax,0x64b8
  return randstate;
    3c85:	a1 b8 64 00 00       	mov    0x64b8,%eax
}
    3c8a:	5d                   	pop    %ebp
    3c8b:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3ca0:	68 37 5d 00 00       	push   $0x5d37
    3ca5:	6a 01                	push   $0x1
    3ca7:	e8 f8 04 00 00       	call   41a4 <printf>
    3cac:	83 c4 10             	add    $0x10,%esp

  if(open("usertests.ran", 0) >= 0){
    3caf:	83 ec 08             	sub    $0x8,%esp
    3cb2:	6a 00                	push   $0x0
    3cb4:	68 4b 5d 00 00       	push   $0x5d4b
    ...
    3cc8:	68 5c 5d 00 00       	push   $0x5d5c
    3ccd:	6a 01                	push   $0x1
    3ccf:	e8 d0 04 00 00       	call   41a4 <printf>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3ce4:	68 4b 5d 00 00       	push   $0x5d4b
...
000040b8 <deadline>:
SYSCALL(deadline)
    40b8:	b8 18 00 00 00       	mov    $0x18,%eax
    40bd:	cd 40                	int    $0x40
    40bf:	c3                   	ret    

000040c0 <sched_policy>:
SYSCALL(sched_policy)
    40c0:	b8 19 00 00 00       	mov    $0x19,%eax
    40c5:	cd 40                	int    $0x40
    40c7:	c3                   	ret    

000040c8 <rate>:
SYSCALL(rate)
    40c8:	b8 1a 00 00 00       	mov    $0x1a,%eax
    40cd:	cd 40                	int    $0x40
    40cf:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    40d3:	83 ec 18             	sub    $0x18,%esp
    40d6:	8b 45 0c             	mov    0xc(%ebp),%eax
    40d9:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    40dc:	83 ec 04             	sub    $0x4,%esp
    40df:	6a 01                	push   $0x1
    40e1:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40e4:	50                   	push   %eax
    40e5:	ff 75 08             	push   0x8(%ebp)
    40e8:	e8 3b ff ff ff       	call   4028 <write>
...
{
    40f3:	55                   	push   %ebp
    40f4:	89 e5                	mov    %esp,%ebp
    40f6:	83 ec 28             	sub    $0x28,%esp
  ...
  neg = 0;
    40f9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    4100:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    4104:	74 17                	je     411d <printint+0x2a>
    4106:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    410a:	79 11                	jns    411d <printint+0x2a>
    neg = 1;
    410c:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    4113:	8b 45 0c             	mov    0xc(%ebp),%eax
    4116:	f7 d8                	neg    %eax
    4118:	89 45 ec             	mov    %eax,-0x14(%ebp)
    411b:	eb 06                	jmp    4123 <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
    4123:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    412a:	8b 4d 10             	mov    0x10(%ebp),%ecx
    412d:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4130:	ba 00 00 00 00       	mov    $0x0,%edx
    4135:	f7 f1                	div    %ecx
    4137:	89 d1                	mov    %edx,%ecx
    4139:	8b 45 f4             	mov    -0xc(%ebp),%eax
    413c:	8d 50 01             	lea    0x1(%eax),%edx
    413f:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4142:	0f b6 91 bc 64 00 00 	movzbl 0x64bc(%ecx),%edx
    4149:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
    414d:	8b 4d 10             	mov    0x10(%ebp),%ecx
    4150:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4153:	ba 00 00 00 00       	mov    $0x0,%edx
    4158:	f7 f1                	div    %ecx
    415a:	89 45 ec             	mov    %eax,-0x14(%ebp)
    415d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4161:	75 c7                	jne    412a <printint+0x37>
  if(neg)
    4163:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4167:	74 2d                	je     4196 <printint+0xa3>
    buf[i++] = '-';
    4169:	8b 45 f4             	mov    -0xc(%ebp),%eax
    416c:	8d 50 01             	lea    0x1(%eax),%edx
    416f:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4172:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4177:	eb 1d                	jmp    4196 <printint+0xa3>
    putc(fd, buf[i]);
    4179:	8d 55 dc             	lea    -0x24(%ebp),%edx
    417c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    417f:	01 d0                	add    %edx,%eax
    4181:	0f b6 00             	movzbl (%eax),%eax
    4184:	0f be c0             	movsbl %al,%eax
    4187:	83 ec 08             	sub    $0x8,%esp
    418a:	50                   	push   %eax
    418b:	ff 75 08             	push   0x8(%ebp)
    418e:	e8 3d ff ff ff       	call   40d0 <putc>
    4193:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    4196:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    419a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    419e:	79 d9                	jns    4179 <printint+0x86>
}
    41a0:	90                   	nop
    41a1:	90                   	nop
    41a2:	c9                   	leave  
...
printf(int fd, const char *fmt, ...)
{
    ...
    41a7:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    41aa:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    41b1:	8d 45 0c             	lea    0xc(%ebp),%eax
    41b4:	83 c0 04             	add    $0x4,%eax
    41b7:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    41ba:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    41c1:	e9 59 01 00 00       	jmp    431f <printf+0x17b>
    c = fmt[i] & 0xff;
    41c6:	8b 55 0c             	mov    0xc(%ebp),%edx
    41c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41cc:	01 d0                	add    %edx,%eax
    41ce:	0f b6 00             	movzbl (%eax),%eax
    41d1:	0f be c0             	movsbl %al,%eax
    41d4:	25 ff 00 00 00       	and    $0xff,%eax
    41d9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    41dc:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41e0:	75 2c                	jne    420e <printf+0x6a>
      if(c == '%'){
    41e2:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41e6:	75 0c                	jne    41f4 <printf+0x50>
        state = '%';
    41e8:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41ef:	e9 27 01 00 00       	jmp    431b <printf+0x177>
      } else {
        putc(fd, c);
    41f4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41f7:	0f be c0             	movsbl %al,%eax
    41fa:	83 ec 08             	sub    $0x8,%esp
    41fd:	50                   	push   %eax
    41fe:	ff 75 08             	push   0x8(%ebp)
    4201:	e8 ca fe ff ff       	call   40d0 <putc>
    4206:	83 c4 10             	add    $0x10,%esp
    4209:	e9 0d 01 00 00       	jmp    431b <printf+0x177>
      }
    } else if(state == '%'){
    420e:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4212:	0f 85 03 01 00 00    	jne    431b <printf+0x177>
      if(c == 'd'){
    4218:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    421c:	75 1e                	jne    423c <printf+0x98>
        printint(fd, *ap, 10, 1);
    421e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4221:	8b 00                	mov    (%eax),%eax
    4223:	6a 01                	push   $0x1
    4225:	6a 0a                	push   $0xa
    4227:	50                   	push   %eax
    4228:	ff 75 08             	push   0x8(%ebp)
    422b:	e8 c3 fe ff ff       	call   40f3 <printint>
    4230:	83 c4 10             	add    $0x10,%esp
        ap++;
    4233:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4237:	e9 d8 00 00 00       	jmp    4314 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    423c:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4240:	74 06                	je     4248 <printf+0xa4>
    4242:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4246:	75 1e                	jne    4266 <printf+0xc2>
        printint(fd, *ap, 16, 0);
    4248:	8b 45 e8             	mov    -0x18(%ebp),%eax
    424b:	8b 00                	mov    (%eax),%eax
    424d:	6a 00                	push   $0x0
    424f:	6a 10                	push   $0x10
    4251:	50                   	push   %eax
    4252:	ff 75 08             	push   0x8(%ebp)
    4255:	e8 99 fe ff ff       	call   40f3 <printint>
    425a:	83 c4 10             	add    $0x10,%esp
        ap++;
    425d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4261:	e9 ae 00 00 00       	jmp    4314 <printf+0x170>
      } else if(c == 's'){
    4266:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    426a:	75 43                	jne    42af <printf+0x10b>
        s = (char*)*ap;
    426c:	8b 45 e8             	mov    -0x18(%ebp),%eax
    426f:	8b 00                	mov    (%eax),%eax
    4271:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4274:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4278:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    427c:	75 25                	jne    42a3 <printf+0xff>
          s = "(null)";
    427e:	c7 45 f4 86 5d 00 00 	movl   $0x5d86,-0xc(%ebp)
        while(*s != 0){
    4285:	eb 1c                	jmp    42a3 <printf+0xff>
          putc(fd, *s);
    4287:	8b 45 f4             	mov    -0xc(%ebp),%eax
    428a:	0f b6 00             	movzbl (%eax),%eax
    428d:	0f be c0             	movsbl %al,%eax
    4290:	83 ec 08             	sub    $0x8,%esp
    4293:	50                   	push   %eax
    4294:	ff 75 08             	push   0x8(%ebp)
    4297:	e8 34 fe ff ff       	call   40d0 <putc>
    429c:	83 c4 10             	add    $0x10,%esp
          s++;
    429f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    42a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42a6:	0f b6 00             	movzbl (%eax),%eax
    42a9:	84 c0                	test   %al,%al
    42ab:	75 da                	jne    4287 <printf+0xe3>
    42ad:	eb 65                	jmp    4314 <printf+0x170>
        }
      } else if(c == 'c'){
    42af:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    42b3:	75 1d                	jne    42d2 <printf+0x12e>
        putc(fd, *ap);
    42b5:	8b 45 e8             	mov    -0x18(%ebp),%eax
    42b8:	8b 00                	mov    (%eax),%eax
    42ba:	0f be c0             	movsbl %al,%eax
    42bd:	83 ec 08             	sub    $0x8,%esp
    42c0:	50                   	push   %eax
    42c1:	ff 75 08             	push   0x8(%ebp)
    42c4:	e8 07 fe ff ff       	call   40d0 <putc>
    42c9:	83 c4 10             	add    $0x10,%esp
        ap++;
    42cc:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42d0:	eb 42                	jmp    4314 <printf+0x170>
      } else if(c == '%'){
    42d2:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42d6:	75 17                	jne    42ef <printf+0x14b>
        putc(fd, c);
    42d8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42db:	0f be c0             	movsbl %al,%eax
    42de:	83 ec 08             	sub    $0x8,%esp
    42e1:	50                   	push   %eax
    42e2:	ff 75 08             	push   0x8(%ebp)
    42e5:	e8 e6 fd ff ff       	call   40d0 <putc>
    42ea:	83 c4 10             	add    $0x10,%esp
    42ed:	eb 25                	jmp    4314 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    42ef:	83 ec 08             	sub    $0x8,%esp
    42f2:	6a 25                	push   $0x25
    42f4:	ff 75 08             	push   0x8(%ebp)
    42f7:	e8 d4 fd ff ff       	call   40d0 <putc>
    42fc:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
    42ff:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4302:	0f be c0             	movsbl %al,%eax
    4305:	83 ec 08             	sub    $0x8,%esp
    4308:	50                   	push   %eax
    4309:	ff 75 08             	push   0x8(%ebp)
    430c:	e8 bf fd ff ff       	call   40d0 <putc>
    4311:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    4314:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    431b:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    431f:	8b 55 0c             	mov    0xc(%ebp),%edx
    4322:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4325:	01 d0                	add    %edx,%eax
    4327:	0f b6 00             	movzbl (%eax),%eax
    432a:	84 c0                	test   %al,%al
    432c:	0f 85 94 fe ff ff    	jne    41c6 <printf+0x22>
    }
  }
}
    4332:	90                   	nop
...
free(void *ap)
{
    ...
    4339:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    433c:	8b 45 08             	mov    0x8(%ebp),%eax
    433f:	83 e8 08             	sub    $0x8,%eax
    4342:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4345:	a1 a8 ac 00 00       	mov    0xaca8,%eax
    434a:	89 45 fc             	mov    %eax,-0x4(%ebp)
    434d:	eb 24                	jmp    4373 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    434f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4352:	8b 00                	mov    (%eax),%eax
    4354:	39 45 fc             	cmp    %eax,-0x4(%ebp)
    4357:	72 12                	jb     436b <free+0x35>
    4359:	8b 45 f8             	mov    -0x8(%ebp),%eax
    435c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    435f:	77 24                	ja     4385 <free+0x4f>
    4361:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4364:	8b 00                	mov    (%eax),%eax
    4366:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    4369:	72 1a                	jb     4385 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    436b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    436e:	8b 00                	mov    (%eax),%eax
    4370:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4373:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4376:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4379:	76 d4                	jbe    434f <free+0x19>
    437b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    437e:	8b 00                	mov    (%eax),%eax
    4380:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    4383:	73 ca                	jae    434f <free+0x19>
      break;
  if(bp + bp->s.size == p->s.ptr){
    4385:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4388:	8b 40 04             	mov    0x4(%eax),%eax
    438b:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4392:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4395:	01 c2                	add    %eax,%edx
    4397:	8b 45 fc             	mov    -0x4(%ebp),%eax
    439a:	8b 00                	mov    (%eax),%eax
    439c:	39 c2                	cmp    %eax,%edx
    439e:	75 24                	jne    43c4 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    43a0:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43a3:	8b 50 04             	mov    0x4(%eax),%edx
    43a6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43a9:	8b 00                	mov    (%eax),%eax
    43ab:	8b 40 04             	mov    0x4(%eax),%eax
    43ae:	01 c2                	add    %eax,%edx
    ...
    43c2:	eb 0a                	jmp    43ce <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    43c4:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43c7:	8b 10                	mov    (%eax),%edx
    43c9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43cc:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    43ce:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43d1:	8b 40 04             	mov    0x4(%eax),%eax
    43d4:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    43db:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43de:	01 d0                	add    %edx,%eax
    43e0:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    43e3:	75 20                	jne    4405 <free+0xcf>
    p->s.size += bp->s.size;
    43e5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43e8:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    p->s.ptr = bp->s.ptr;
    43f9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43fc:	8b 10                	mov    (%eax),%edx
    43fe:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4401:	89 10                	mov    %edx,(%eax)
    4403:	eb 08                	jmp    440d <free+0xd7>
  } else
    p->s.ptr = bp;
    4405:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4408:	8b 55 f8             	mov    -0x8(%ebp),%edx
    440b:	89 10                	mov    %edx,(%eax)
  freep = p;
    440d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4410:	a3 a8 ac 00 00       	mov    %eax,0xaca8
}
    4415:	90                   	nop
    4416:	c9                   	leave  
    4417:	c3                   	ret    
...
{
    4418:	55                   	push   %ebp
    4419:	89 e5                	mov    %esp,%ebp
    441b:	83 ec 18             	sub    $0x18,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    441e:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4425:	77 07                	ja     442e <morecore+0x16>
    nu = 4096;
    4427:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    442e:	8b 45 08             	mov    0x8(%ebp),%eax
    4431:	c1 e0 03             	shl    $0x3,%eax
    4434:	83 ec 0c             	sub    $0xc,%esp
    4437:	50                   	push   %eax
    4438:	e8 53 fc ff ff       	call   4090 <sbrk>
    443d:	83 c4 10             	add    $0x10,%esp
    4440:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4443:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4447:	75 07                	jne    4450 <morecore+0x38>
    return 0;
    4449:	b8 00 00 00 00       	mov    $0x0,%eax
    444e:	eb 26                	jmp    4476 <morecore+0x5e>
  hp = (Header*)p;
    4450:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4453:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4456:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4459:	8b 55 08             	mov    0x8(%ebp),%edx
    445c:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    445f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4462:	83 c0 08             	add    $0x8,%eax
    4465:	83 ec 0c             	sub    $0xc,%esp
    4468:	50                   	push   %eax
    4469:	e8 c8 fe ff ff       	call   4336 <free>
    446e:	83 c4 10             	add    $0x10,%esp
  return freep;
    4471:	a1 a8 ac 00 00       	mov    0xaca8,%eax
}
    4476:	c9                   	leave  
    4477:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    448d:	a1 a8 ac 00 00       	mov    0xaca8,%eax
    4492:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4495:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4499:	75 23                	jne    44be <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    449b:	c7 45 f0 a0 ac 00 00 	movl   $0xaca0,-0x10(%ebp)
    44a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44a5:	a3 a8 ac 00 00       	mov    %eax,0xaca8
    44aa:	a1 a8 ac 00 00       	mov    0xaca8,%eax
    44af:	a3 a0 ac 00 00       	mov    %eax,0xaca0
    base.s.size = 0;
    44b4:	c7 05 a4 ac 00 00 00 	movl   $0x0,0xaca4
    44bb:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    44cc:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    44cf:	77 4d                	ja     451e <malloc+0xa6>
      if(p->s.size == nunits)
    44d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44d4:	8b 40 04             	mov    0x4(%eax),%eax
    44d7:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    ...
    4511:	a3 a8 ac 00 00       	mov    %eax,0xaca8
      return (void*)(p + 1);
    4516:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4519:	83 c0 08             	add    $0x8,%eax
    451c:	eb 3b                	jmp    4559 <malloc+0xe1>
    }
    if(p == freep)
    451e:	a1 a8 ac 00 00       	mov    0xaca8,%eax
    4523:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4526:	75 1e                	jne    4546 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    4528:	83 ec 0c             	sub    $0xc,%esp
    452b:	ff 75 ec             	push   -0x14(%ebp)
    452e:	e8 e5 fe ff ff       	call   4418 <morecore>
    4533:	83 c4 10             	add    $0x10,%esp
    4536:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4539:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    453d:	75 07                	jne    4546 <malloc+0xce>
        return 0;
    453f:	b8 00 00 00 00       	mov    $0x0,%eax
    4544:	eb 13                	jmp    4559 <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4546:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4549:	89 45 f0             	mov    %eax,-0x10(%ebp)
    454c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    454f:	8b 00                	mov    (%eax),%eax
    4551:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4554:	e9 6d ff ff ff       	jmp    44c6 <malloc+0x4e>
  }
}
    4559:	c9                   	leave  
    455a:	c3                   	ret    
