...
main(int argc, char *argv[])
{
 ...
 111:	68 d8 0a 00 00       	push   $0xad8
 116:	6a 02                	push   $0x2
 118:	e8 03 06 00 00       	call   720 <printf>
 ...
 18d:	50                   	push   %eax
 18e:	68 f8 0a 00 00       	push   $0xaf8
 193:	6a 01                	push   $0x1
 195:	e8 86 05 00 00       	call   720 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 675:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 67c:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 680:	74 17                	je     699 <printint+0x2a>
 682:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 686:	79 11                	jns    699 <printint+0x2a>
    neg = 1;
 ...
 697:	eb 06                	jmp    69f <printint+0x30>
  } else {
    x = xx;
 ...
 69c:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  i = 0;
 69f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 6a6:	8b 4d 10             	mov    0x10(%ebp),%ecx
 ...
 6be:	0f b6 91 e0 0d 00 00 	movzbl 0xde0(%ecx),%edx
 6c5:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
 ...
 6dd:	75 c7                	jne    6a6 <printint+0x37>
  if(neg)
 6df:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6e3:	74 2d                	je     712 <printint+0xa3>
    buf[i++] = '-';
 6e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 6e8:	8d 50 01             	lea    0x1(%eax),%edx
 6eb:	89 55 f4             	mov    %edx,-0xc(%ebp)
 6ee:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 6f3:	eb 1d                	jmp    712 <printint+0xa3>
    putc(fd, buf[i]);
 ...
 70a:	e8 3d ff ff ff       	call   64c <putc>
 70f:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
 712:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
 716:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 71a:	79 d9                	jns    6f5 <printint+0x86>
}
 71c:	90                   	nop
 71d:	90                   	nop
 71e:	c9                   	leave  
...
printf(int fd, const char *fmt, ...)
{
 ...
 77d:	e8 ca fe ff ff       	call   64c <putc>
 ...
 7a7:	e8 c3 fe ff ff       	call   66f <printint>
 ...
 7d1:	e8 99 fe ff ff       	call   66f <printint>
 ...
 7f8:	75 25                	jne    81f <printf+0xff>
          s = "(null)";
 7fa:	c7 45 f4 0e 0b 00 00 	movl   $0xb0e,-0xc(%ebp)
        while(*s != 0){
 ...
 813:	e8 34 fe ff ff       	call   64c <putc>
 ...
 840:	e8 07 fe ff ff       	call   64c <putc>
 ...
 861:	e8 e6 fd ff ff       	call   64c <putc>
 ...
 873:	e8 d4 fd ff ff       	call   64c <putc>
 ...
 888:	e8 bf fd ff ff       	call   64c <putc>
...
free(void *ap)
{
 ...
 8c1:	a1 08 12 00 00       	mov    0x1208,%eax
 ...
 98c:	a3 08 12 00 00       	mov    %eax,0x1208
}
 991:	90                   	nop
 992:	c9                   	leave  
 993:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 9b3:	50                   	push   %eax
 9b4:	e8 53 fc ff ff       	call   60c <sbrk>
 ...
 9ea:	83 c4 10             	add    $0x10,%esp
  return freep;
 9ed:	a1 08 12 00 00       	mov    0x1208,%eax
}
 9f2:	c9                   	leave  
 9f3:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a17:	c7 45 f0 00 12 00 00 	movl   $0x1200,-0x10(%ebp)
 a1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a21:	a3 08 12 00 00       	mov    %eax,0x1208
 a26:	a1 08 12 00 00       	mov    0x1208,%eax
 a2b:	a3 00 12 00 00       	mov    %eax,0x1200
    base.s.size = 0;
 a30:	c7 05 04 12 00 00 00 	movl   $0x0,0x1204
 a37:	00 00 00 
  }
 ...
 a4b:	77 4d                	ja     a9a <malloc+0xa6>
      if(p->s.size == nunits)
 a4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a50:	8b 40 04             	mov    0x4(%eax),%eax
 a53:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 ...
 a8d:	a3 08 12 00 00       	mov    %eax,0x1208
      return (void*)(p + 1);
