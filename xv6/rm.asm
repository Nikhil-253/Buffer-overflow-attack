...
printint(int fd, int xx, int base, int sgn)
{
 ...
 421:	0f b6 91 b8 0a 00 00 	movzbl 0xab8(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 55b:	75 25                	jne    582 <printf+0xff>
          s = "(null)";
 55d:	c7 45 f4 67 08 00 00 	movl   $0x867,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 624:	a1 d4 0a 00 00       	mov    0xad4,%eax
 ...
 6ef:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 6f4:	90                   	nop
 6f5:	c9                   	leave  
 6f6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 74d:	83 c4 10             	add    $0x10,%esp
  return freep;
 750:	a1 d4 0a 00 00       	mov    0xad4,%eax
}
 755:	c9                   	leave  
 756:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 769:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 76c:	a1 d4 0a 00 00       	mov    0xad4,%eax
 771:	89 45 f0             	mov    %eax,-0x10(%ebp)
 774:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 778:	75 23                	jne    79d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 77a:	c7 45 f0 cc 0a 00 00 	movl   $0xacc,-0x10(%ebp)
 781:	8b 45 f0             	mov    -0x10(%ebp),%eax
 784:	a3 d4 0a 00 00       	mov    %eax,0xad4
 789:	a1 d4 0a 00 00       	mov    0xad4,%eax
 78e:	a3 cc 0a 00 00       	mov    %eax,0xacc
    base.s.size = 0;
 793:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 79a:	00 00 00 
  }
 ...
 7f0:	a3 d4 0a 00 00       	mov    %eax,0xad4
      return (void*)(p + 1);
