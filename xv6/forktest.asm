...
0000041f <rate>:
SYSCALL(rate)
 41f:	b8 1a 00 00 00       	mov    $0x1a,%eax
 424:	cd 40                	int    $0x40
 426:	c3                   	ret    
