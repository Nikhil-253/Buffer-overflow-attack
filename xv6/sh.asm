...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 73 14 00 00       	push   $0x1473
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     341:	50                   	push   %eax
     342:	68 7b 14 00 00       	push   $0x147b
     347:	6a 02                	push   $0x2
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 89 14 00 00       	push   $0x1489
     3ad:	6a 02                	push   $0x2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 8d 14 00 00       	push   $0x148d
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 53 0f 00 00       	call   1348 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 1d 0f 00 00       	call   1348 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 ba 0e 00 00       	call   1348 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 72 0e 00 00       	call   1348 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 2a 0e 00 00       	call   1348 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 a4 19 00 00       	push   $0x19a4
     ...
     63b:	50                   	push   %eax
     63c:	68 ac 19 00 00       	push   $0x19ac
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67e:	50                   	push   %eax
     67f:	68 a4 19 00 00       	push   $0x19a4
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c5:	50                   	push   %eax
     6c6:	68 a4 19 00 00       	push   $0x19a4
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     749:	68 92 14 00 00       	push   $0x1492
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76b:	50                   	push   %eax
     76c:	68 93 14 00 00       	push   $0x1493
     771:	6a 02                	push   $0x2
     773:	e8 fc 08 00 00       	call   1074 <printf>
     778:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77b:	83 ec 0c             	sub    $0xc,%esp
     77e:	68 a2 14 00 00       	push   $0x14a2
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e3:	68 a9 14 00 00       	push   $0x14a9
  ...
  if(peek(ps, es, ";")){
     ...
     7fd:	68 ab 14 00 00       	push   $0x14ab
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86b:	68 ad 14 00 00       	push   $0x14ad
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fa:	68 af 14 00 00       	push   $0x14af
  ...
  while(peek(ps, es, "<>")){
     ...
     984:	68 cc 14 00 00       	push   $0x14cc
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9ad:	68 cf 14 00 00       	push   $0x14cf
    ...
    panic("parseblock");
     ...
     9c7:	68 d1 14 00 00       	push   $0x14d1
  ...
  if(!peek(ps, es, ")"))
     ...
     9fd:	68 dc 14 00 00       	push   $0x14dc
    ...
    panic("syntax - missing )");
     ...
     a17:	68 de 14 00 00       	push   $0x14de
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a5b:	68 cf 14 00 00       	push   $0x14cf
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae5:	68 a2 14 00 00       	push   $0x14a2
    ...
    if(argc >= MAXARGS)
     ...
     b1c:	68 f1 14 00 00       	push   $0x14f1
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b43:	68 ff 14 00 00       	push   $0x14ff
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba9:	8b 04 85 04 15 00 00 	mov    0x1504(,%eax,4),%eax
     bb0:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
00000f88 <deadline>:
SYSCALL(deadline)
     f88:	b8 18 00 00 00       	mov    $0x18,%eax
     f8d:	cd 40                	int    $0x40
     f8f:	c3                   	ret    

00000f90 <sched_policy>:
SYSCALL(sched_policy)
     f90:	b8 19 00 00 00       	mov    $0x19,%eax
     f95:	cd 40                	int    $0x40
     f97:	c3                   	ret    

00000f98 <rate>:
SYSCALL(rate)
     f98:	b8 1a 00 00 00       	mov    $0x1a,%eax
     f9d:	cd 40                	int    $0x40
     f9f:	c3                   	ret    
...
putc(int fd, char c)
{
     ...
     fa9:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     fac:	83 ec 04             	sub    $0x4,%esp
     faf:	6a 01                	push   $0x1
     fb1:	8d 45 f4             	lea    -0xc(%ebp),%eax
     fb4:	50                   	push   %eax
     fb5:	ff 75 08             	push   0x8(%ebp)
     fb8:	e8 3b ff ff ff       	call   ef8 <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     fd4:	74 17                	je     fed <printint+0x2a>
     fd6:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     fda:	79 11                	jns    fed <printint+0x2a>
    neg = 1;
    ...
    x = -xx;
     ...
     feb:	eb 06                	jmp    ff3 <printint+0x30>
  } else {
    x = xx;
  ...
  do{
    ...
    1005:	f7 f1                	div    %ecx
    1007:	89 d1                	mov    %edx,%ecx
    1009:	8b 45 f4             	mov    -0xc(%ebp),%eax
    100c:	8d 50 01             	lea    0x1(%eax),%edx
    100f:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1012:	0f b6 91 b4 19 00 00 	movzbl 0x19b4(%ecx),%edx
    1019:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
    101d:	8b 4d 10             	mov    0x10(%ebp),%ecx
    ...
    1031:	75 c7                	jne    ffa <printint+0x37>
  if(neg)
    1033:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1037:	74 2d                	je     1066 <printint+0xa3>
    buf[i++] = '-';
  ...
  while(--i >= 0)
    1047:	eb 1d                	jmp    1066 <printint+0xa3>
    putc(fd, buf[i]);
    ...
    105a:	50                   	push   %eax
    105b:	ff 75 08             	push   0x8(%ebp)
    105e:	e8 3d ff ff ff       	call   fa0 <putc>
    1063:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    1066:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    106a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    106e:	79 d9                	jns    1049 <printint+0x86>
}
    1070:	90                   	nop
    1071:	90                   	nop
    1072:	c9                   	leave  
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10cd:	50                   	push   %eax
    10ce:	ff 75 08             	push   0x8(%ebp)
    10d1:	e8 ca fe ff ff       	call   fa0 <putc>
    ...
    10f5:	6a 0a                	push   $0xa
    10f7:	50                   	push   %eax
    10f8:	ff 75 08             	push   0x8(%ebp)
    10fb:	e8 c3 fe ff ff       	call   fc3 <printint>
    ...
    1121:	50                   	push   %eax
    1122:	ff 75 08             	push   0x8(%ebp)
    1125:	e8 99 fe ff ff       	call   fc3 <printint>
    ...
    114c:	75 25                	jne    1173 <printf+0xff>
          s = "(null)";
    114e:	c7 45 f4 1c 15 00 00 	movl   $0x151c,-0xc(%ebp)
        while(*s != 0){
    ...
    1163:	50                   	push   %eax
    1164:	ff 75 08             	push   0x8(%ebp)
    1167:	e8 34 fe ff ff       	call   fa0 <putc>
    ...
    1190:	50                   	push   %eax
    1191:	ff 75 08             	push   0x8(%ebp)
    1194:	e8 07 fe ff ff       	call   fa0 <putc>
    ...
    11b1:	50                   	push   %eax
    11b2:	ff 75 08             	push   0x8(%ebp)
    11b5:	e8 e6 fd ff ff       	call   fa0 <putc>
    ...
    11c4:	ff 75 08             	push   0x8(%ebp)
    11c7:	e8 d4 fd ff ff       	call   fa0 <putc>
    ...
    11d8:	50                   	push   %eax
    11d9:	ff 75 08             	push   0x8(%ebp)
    11dc:	e8 bf fd ff ff       	call   fa0 <putc>
...
free(void *ap)
{
    ...
    1209:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    120c:	8b 45 08             	mov    0x8(%ebp),%eax
    120f:	83 e8 08             	sub    $0x8,%eax
    1212:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1215:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    121a:	89 45 fc             	mov    %eax,-0x4(%ebp)
    121d:	eb 24                	jmp    1243 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    121f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1222:	8b 00                	mov    (%eax),%eax
    1224:	39 45 fc             	cmp    %eax,-0x4(%ebp)
    1227:	72 12                	jb     123b <free+0x35>
    1229:	8b 45 f8             	mov    -0x8(%ebp),%eax
    122c:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    122f:	77 24                	ja     1255 <free+0x4f>
    1231:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1234:	8b 00                	mov    (%eax),%eax
    1236:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    1239:	72 1a                	jb     1255 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    12ee:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    12f5:	77 07                	ja     12fe <morecore+0x16>
    nu = 4096;
    12f7:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    12fe:	8b 45 08             	mov    0x8(%ebp),%eax
    1301:	c1 e0 03             	shl    $0x3,%eax
    1304:	83 ec 0c             	sub    $0xc,%esp
    1307:	50                   	push   %eax
    1308:	e8 53 fc ff ff       	call   f60 <sbrk>
    130d:	83 c4 10             	add    $0x10,%esp
    1310:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    1313:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1317:	75 07                	jne    1320 <morecore+0x38>
    return 0;
    1319:	b8 00 00 00 00       	mov    $0x0,%eax
    131e:	eb 26                	jmp    1346 <morecore+0x5e>
  hp = (Header*)p;
    1320:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1323:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    1326:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1329:	8b 55 08             	mov    0x8(%ebp),%edx
    132c:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    132f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1332:	83 c0 08             	add    $0x8,%eax
    1335:	83 ec 0c             	sub    $0xc,%esp
    1338:	50                   	push   %eax
    1339:	e8 c8 fe ff ff       	call   1206 <free>
    133e:	83 c4 10             	add    $0x10,%esp
  return freep;
    1341:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
}
    1346:	c9                   	leave  
    1347:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    134b:	83 ec 18             	sub    $0x18,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    134e:	8b 45 08             	mov    0x8(%ebp),%eax
    1351:	83 c0 07             	add    $0x7,%eax
    1354:	c1 e8 03             	shr    $0x3,%eax
    1357:	83 c0 01             	add    $0x1,%eax
    135a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    135d:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    1362:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1365:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1369:	75 23                	jne    138e <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    136b:	c7 45 f0 44 1a 00 00 	movl   $0x1a44,-0x10(%ebp)
    1372:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1375:	a3 4c 1a 00 00       	mov    %eax,0x1a4c
    137a:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    137f:	a3 44 1a 00 00       	mov    %eax,0x1a44
    base.s.size = 0;
    1384:	c7 05 48 1a 00 00 00 	movl   $0x0,0x1a48
    138b:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    138e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1391:	8b 00                	mov    (%eax),%eax
    1393:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    1396:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1399:	8b 40 04             	mov    0x4(%eax),%eax
    139c:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    139f:	77 4d                	ja     13ee <malloc+0xa6>
      if(p->s.size == nunits)
    13a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13a4:	8b 40 04             	mov    0x4(%eax),%eax
    13a7:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    13aa:	75 0c                	jne    13b8 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    13ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13af:	8b 10                	mov    (%eax),%edx
    13b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13b4:	89 10                	mov    %edx,(%eax)
    13b6:	eb 26                	jmp    13de <malloc+0x96>
      else {
        p->s.size -= nunits;
    13b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13bb:	8b 40 04             	mov    0x4(%eax),%eax
    13be:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    13cf:	c1 e0 03             	shl    $0x3,%eax
    13d2:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    13d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13d8:	8b 55 ec             	mov    -0x14(%ebp),%edx
    13db:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    13de:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13e1:	a3 4c 1a 00 00       	mov    %eax,0x1a4c
      return (void*)(p + 1);
    13e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13e9:	83 c0 08             	add    $0x8,%eax
    13ec:	eb 3b                	jmp    1429 <malloc+0xe1>
    }
    if(p == freep)
    13ee:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    13f3:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    13f6:	75 1e                	jne    1416 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    13f8:	83 ec 0c             	sub    $0xc,%esp
    13fb:	ff 75 ec             	push   -0x14(%ebp)
    13fe:	e8 e5 fe ff ff       	call   12e8 <morecore>
    1403:	83 c4 10             	add    $0x10,%esp
    1406:	89 45 f4             	mov    %eax,-0xc(%ebp)
    1409:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    140d:	75 07                	jne    1416 <malloc+0xce>
        return 0;
    140f:	b8 00 00 00 00       	mov    $0x0,%eax
    1414:	eb 13                	jmp    1429 <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1416:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1419:	89 45 f0             	mov    %eax,-0x10(%ebp)
    141c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    141f:	8b 00                	mov    (%eax),%eax
    1421:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    1424:	e9 6d ff ff ff       	jmp    1396 <malloc+0x4e>
  }
}
    1429:	c9                   	leave  
    142a:	c3                   	ret    
